 ...
 */
public class DVLMFilteredContainingResolvingEList<DVLM_OBJECT> extends EObjectContainmentEList.Resolving<DVLM_OBJECT> implements EList<DVLM_OBJECT> {
	 ...
	 * @param featureID The feature id telling if the list is operating on relations or CatgeoryAssignments ettc.
	 */
	public DVLMFilteredContainingResolvingEList(Class<?> dataClass, InternalEObject owner, int featureID) {
