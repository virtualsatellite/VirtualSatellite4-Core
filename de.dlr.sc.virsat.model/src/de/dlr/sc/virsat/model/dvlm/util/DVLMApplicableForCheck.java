...
import de.dlr.sc.virsat.model.dvlm.util.rules.DVLMApplicableForCardinalityRule;
 ...
 *
 */
public class DVLMApplicableForCheck extends DVLMIsActiveCheck {
	 ...
	 */
	public DVLMApplicableForCheck(Object owner, boolean containment) {
		super(owner, containment);
		rules.add(new DVLMApplicableForCardinalityRule());
	}
}
