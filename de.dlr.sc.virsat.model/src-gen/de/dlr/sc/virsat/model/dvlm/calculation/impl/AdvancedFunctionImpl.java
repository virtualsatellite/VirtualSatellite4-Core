...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Advanced Function</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dlr.sc.virsat.model.dvlm.calculation.impl.AdvancedFunctionImpl#getInputs <em>Inputs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdvancedFunctionImpl extends AAdvancedFunctionImpl implements AdvancedFunction {
	/**
	 ...
	 * @ordered
	 */
	protected EList<AExpression> inputs;
	 ...
	 * @generated
	 */
	protected AdvancedFunctionImpl() {
		super();
	...
	protected EClass eStaticClass() {
		return CalculationPackage.Literals.ADVANCED_FUNCTION;
	}
	...
	public EList<AExpression> getInputs() {
		if (inputs == null) {
			inputs = new EObjectContainmentEList.Resolving<AExpression>(AExpression.class, this, CalculationPackage.ADVANCED_FUNCTION__INPUTS);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case CalculationPackage.ADVANCED_FUNCTION__INPUTS:
				getInputs().clear();
				getInputs().addAll((Collection<? extends AExpression>)newValue);
				return;
		}
