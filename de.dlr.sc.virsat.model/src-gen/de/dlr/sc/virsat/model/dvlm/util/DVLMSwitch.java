 ...
 * <!-- end-user-doc -->
 * @see de.dlr.sc.virsat.model.dvlm.DVLMPackage
 * @generated
 */
public class DVLMSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static DVLMPackage modelPackage;
	...
	public DVLMSwitch() {
		if (modelPackage == null) {
			modelPackage = DVLMPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DVLMPackage.REPOSITORY: {
				Repository repository = (Repository)theEObject;
				T result = caseRepository(repository);
				if (result == null) result = caseIUuid(repository);
				if (result == null) result = caseIAssignedDiscipline(repository);
