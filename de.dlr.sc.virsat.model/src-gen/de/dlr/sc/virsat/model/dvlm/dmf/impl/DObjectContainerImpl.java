...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>DObject Container</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dlr.sc.virsat.model.dvlm.dmf.impl.DObjectContainerImpl#getObjects <em>Objects</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DObjectContainerImpl extends MinimalEObjectImpl.Container implements DObjectContainer {
	/**
	 ...
	 * @ordered
	 */
	protected EList<DObject> objects;
	 ...
	 * @generated
	 */
	protected DObjectContainerImpl() {
		super();
	...
	protected EClass eStaticClass() {
		return DmfPackage.Literals.DOBJECT_CONTAINER;
	}
	...
	public EList<DObject> getObjects() {
		if (objects == null) {
			objects = new EObjectContainmentEList.Resolving<DObject>(DObject.class, this, DmfPackage.DOBJECT_CONTAINER__OBJECTS);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case DmfPackage.DOBJECT_CONTAINER__OBJECTS:
				getObjects().clear();
				getObjects().addAll((Collection<? extends DObject>)newValue);
				return;
		}
