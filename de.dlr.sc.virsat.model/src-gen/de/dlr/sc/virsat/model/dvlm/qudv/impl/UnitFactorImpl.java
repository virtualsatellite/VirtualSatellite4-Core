 ...
 * </p>
 * <ul>
 *   <li>{@link de.dlr.sc.virsat.model.dvlm.qudv.impl.UnitFactorImpl#getUuid <em>Uuid</em>}</li>
 *   <li>{@link de.dlr.sc.virsat.model.dvlm.qudv.impl.UnitFactorImpl#getExponent <em>Exponent</em>}</li>
 *   <li>{@link de.dlr.sc.virsat.model.dvlm.qudv.impl.UnitFactorImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnitFactorImpl extends MinimalEObjectImpl.Container implements UnitFactor {
	...
	protected EClass eStaticClass() {
		return QudvPackage.Literals.UNIT_FACTOR;
	}
	...
	public void setUuid(VirSatUuid newUuid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QudvPackage.UNIT_FACTOR__UUID, oldUuid, uuid));
	}
	...
	public void setExponent(double newExponent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QudvPackage.UNIT_FACTOR__EXPONENT, oldExponent, exponent));
	}
	...
	public AUnit getUnit() {
		if (unit != null && unit.eIsProxy()) {
			...
			if (unit != oldUnit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QudvPackage.UNIT_FACTOR__UNIT, oldUnit, unit));
			}
		}
		return unit;
	}
	...
	public void setUnit(AUnit newUnit) {
		...
		unit = newUnit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QudvPackage.UNIT_FACTOR__UNIT, oldUnit, unit));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QudvPackage.UNIT_FACTOR__UUID:
				return getUuid();
			case QudvPackage.UNIT_FACTOR__EXPONENT:
				return getExponent();
			case QudvPackage.UNIT_FACTOR__UNIT:
