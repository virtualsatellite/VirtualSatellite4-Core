 ...
 *******************************************************************************/
package de.dlr.sc.virsat.model.dvlm.units.util;
...
public class UnitsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UnitsPackage.UNIT_MANAGEMENT: {
				UnitManagement unitManagement = (UnitManagement)theEObject;
				T result = caseUnitManagement(unitManagement);
				if (result == null) result = caseIAssignedDiscipline(unitManagement);
				if (result == null) result = caseIUuid(unitManagement);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Unit Management</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Unit Management</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUnitManagement(UnitManagement object) {
		return null;
	}
