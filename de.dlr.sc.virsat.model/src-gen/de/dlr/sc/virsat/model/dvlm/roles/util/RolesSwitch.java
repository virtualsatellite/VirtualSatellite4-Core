...
public class RolesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RolesPackage.ROLE_MANAGEMENT: {
				RoleManagement roleManagement = (RoleManagement)theEObject;
				T result = caseRoleManagement(roleManagement);
				if (result == null) result = caseIAssignedDiscipline(roleManagement);
				if (result == null) result = caseIUuid(roleManagement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RolesPackage.DISCIPLINE: {
				Discipline discipline = (Discipline)theEObject;
				T result = caseDiscipline(discipline);
				if (result == null) result = caseIUuid(discipline);
				if (result == null) result = caseIName(discipline);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
