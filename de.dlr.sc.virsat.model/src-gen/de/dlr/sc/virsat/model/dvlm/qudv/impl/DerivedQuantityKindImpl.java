 ...
 * </p>
 * <ul>
 *   <li>{@link de.dlr.sc.virsat.model.dvlm.qudv.impl.DerivedQuantityKindImpl#getFactor <em>Factor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DerivedQuantityKindImpl extends AQuantityKindImpl implements DerivedQuantityKind {
	/**
	 ...
	 * @ordered
	 */
	protected EList<QuantityKindFactor> factor;
	...
	protected EClass eStaticClass() {
		return QudvPackage.Literals.DERIVED_QUANTITY_KIND;
	}
	...
	public EList<QuantityKindFactor> getFactor() {
		if (factor == null) {
			factor = new EObjectContainmentEList.Resolving<QuantityKindFactor>(QuantityKindFactor.class, this, QudvPackage.DERIVED_QUANTITY_KIND__FACTOR);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case QudvPackage.DERIVED_QUANTITY_KIND__FACTOR:
				getFactor().clear();
				getFactor().addAll((Collection<? extends QuantityKindFactor>)newValue);
				return;
		}
