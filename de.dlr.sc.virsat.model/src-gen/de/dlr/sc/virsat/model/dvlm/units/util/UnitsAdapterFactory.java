...
public class UnitsAdapterFactory extends AdapterFactoryImpl {
	...
	protected UnitsSwitch<Adapter> modelSwitch =
		new UnitsSwitch<Adapter>() {
			@Override
			public Adapter caseUnitManagement(UnitManagement object) {
				return createUnitManagementAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dlr.sc.virsat.model.dvlm.units.UnitManagement <em>Unit Management</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createUnitManagementAdapter() {
		return null;
	}
