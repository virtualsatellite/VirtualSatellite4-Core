 ...
 * </p>
 * <ul>
 *   <li>{@link de.dlr.sc.virsat.model.dvlm.dmf.impl.DObjectImpl#getUuid <em>Uuid</em>}</li>
 *   <li>{@link de.dlr.sc.virsat.model.dvlm.dmf.impl.DObjectImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DObjectImpl extends MinimalEObjectImpl.Container implements DObject {
	/**
	...
	protected EClass eStaticClass() {
		return DmfPackage.Literals.DOBJECT;
	}
	...
	public void setUuid(VirSatUuid newUuid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmfPackage.DOBJECT__UUID, oldUuid, uuid));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DmfPackage.DOBJECT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DmfPackage.DOBJECT__UUID:
				return getUuid();
			case DmfPackage.DOBJECT__NAME:
				return getName();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == IName.class) {
			switch (derivedFeatureID) {
				case DmfPackage.DOBJECT__NAME: return GeneralPackage.INAME__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IName.class) {
			switch (baseFeatureID) {
				case GeneralPackage.INAME__NAME: return DmfPackage.DOBJECT__NAME;
				default: return -1;
			}
		}
