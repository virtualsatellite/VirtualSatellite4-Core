 ...
 * </p>
 * <ul>
 *   <li>{@link de.dlr.sc.virsat.model.dvlm.qudv.impl.DerivedUnitImpl#getFactor <em>Factor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DerivedUnitImpl extends AUnitImpl implements DerivedUnit {
	/**
	 ...
	 * @ordered
	 */
	protected EList<UnitFactor> factor;
	...
	protected EClass eStaticClass() {
		return QudvPackage.Literals.DERIVED_UNIT;
	}
	...
	public EList<UnitFactor> getFactor() {
		if (factor == null) {
			factor = new EObjectContainmentEList.Resolving<UnitFactor>(UnitFactor.class, this, QudvPackage.DERIVED_UNIT__FACTOR);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case QudvPackage.DERIVED_UNIT__FACTOR:
				getFactor().clear();
				getFactor().addAll((Collection<? extends UnitFactor>)newValue);
				return;
		}
