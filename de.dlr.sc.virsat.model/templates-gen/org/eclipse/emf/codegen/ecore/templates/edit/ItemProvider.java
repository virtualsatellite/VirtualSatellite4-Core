...
public class ItemProvider
{
  ...
  protected final String TEXT_76 = " " + NL + "\t\tString labelName =((";
  protected final String TEXT_77 = ")object).getName();";
  protected final String TEXT_78 = NL + "\t\tString label =((";
  protected final String TEXT_79 = ")object).";
  protected final String TEXT_80 = "();" + NL + "\t\treturn labelName + \": \" + label;";
  protected final String TEXT_81 = " " + NL + "\t";
  protected final String TEXT_82 = "\t" + NL + "\t";
  protected final String TEXT_83 = NL + "\t\t\treturn ((";
  protected final String TEXT_84 = ")getStyledText(object)).getString();" + NL + "\t";
  protected final String TEXT_85 = NL + "\t\t\t";
  protected final String TEXT_86 = "<?, ?>";
  protected final String TEXT_87 = " = (";
  protected final String TEXT_88 = ")object;" + NL + "  \t";
  ...
  protected final String TEXT_103 = ")object;" + NL + "\t\t\treturn getString(\"_UI_";
  protected final String TEXT_104 = "_type\") + \" \" + ";
  protected final String TEXT_105 = "();";
  protected final String TEXT_106 = NL + "      \t";
  protected final String TEXT_107 = NL + "\t\t\tString label = crop(((";
  protected final String TEXT_108 = "());" + NL + "      \t";
  protected final String TEXT_109 = NL + "\t\t\tString label = ((";
  protected final String TEXT_110 = "();" + NL + "      \t";
  protected final String TEXT_111 = " labelValue = ((";
  protected final String TEXT_112 = ")object).eGet(";
  protected final String TEXT_113 = ");" + NL + "      \t";
  protected final String TEXT_114 = NL + "\t\t\tString label = labelValue == null ? null : labelValue.toString();" + NL + "    \t";
  ...
  protected final String TEXT_121 = NL + "\t/**" + NL + "\t * This returns the label styled text for the adapted class." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_122 = NL + "\tpublic Object getStyledText(Object object)" + NL + "\t{";
  protected final String TEXT_123 = ")object;";
  protected final String TEXT_124 = NL + "\t\treturn new ";
  protected final String TEXT_125 = "(\"\" + ";
  protected final String TEXT_126 = ".getKey()).append(\" -> \", ";
  protected final String TEXT_127 = ".QUALIFIER_STYLER).append(\"\" + ";
  protected final String TEXT_128 = NL + "\t\tString key = crop(\"\" + ";
  protected final String TEXT_129 = NL + "\t\tString key = \"\" + ";
  protected final String TEXT_130 = NL + "\t\tString value = crop(\"\" + ";
  protected final String TEXT_131 = NL + "\t\tString value = \"\" + ";
  protected final String TEXT_132 = "(key).append(\" -> \", ";
  protected final String TEXT_133 = ".QUALIFIER_STYLER).append(value);";
  protected final String TEXT_134 = ")object;" + NL + "\t\treturn new ";
  protected final String TEXT_135 = "(getString(\"_UI_";
  protected final String TEXT_136 = "_type\"), ";
  protected final String TEXT_137 = ".QUALIFIER_STYLER).append(\" \").append(";
  protected final String TEXT_138 = ".toString(";
  protected final String TEXT_139 = "()));";
  protected final String TEXT_140 = NL + "\t\tString label = crop(((";
  protected final String TEXT_141 = "());";
  protected final String TEXT_142 = NL + "\t\tString label = ((";
  protected final String TEXT_143 = NL + "\t\tString label = labelValue == null ? null : labelValue.toString();";
  protected final String TEXT_144 = " styledLabel = new ";
  protected final String TEXT_145 = "();" + NL + "\t\tif (label == null || label.length() == 0) " + NL + "\t\t{" + NL + "\t\t\tstyledLabel.append(getString(\"_UI_";
  protected final String TEXT_146 = ".QUALIFIER_STYLER); ";
  protected final String TEXT_147 = NL + "\t\t} else {" + NL + "\t\t\tstyledLabel.append(getString(\"_UI_";
  protected final String TEXT_148 = ".QUALIFIER_STYLER).append(\" \" + label);";
  protected final String TEXT_149 = NL + "\t\t}" + NL + "\t\treturn styledLabel;";
  protected final String TEXT_150 = "_type\"));";
  protected final String TEXT_151 = NL + "\t}\t";
  protected final String TEXT_152 = NL + NL + "\t/**" + NL + "\t * This handles model notifications by calling {@link #updateChildren} to update any cached" + NL + "\t * children and by creating a viewer notification, which it passes to {@link #fireNotifyChanged}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_153 = NL + "\tpublic void notifyChanged(Notification notification)" + NL + "\t{" + NL + "\t\tupdateChildren(notification);";
  protected final String TEXT_154 = NL + NL + "\t\tswitch (notification.getFeatureID(";
  protected final String TEXT_155 = ".class))" + NL + "\t\t{";
  protected final String TEXT_156 = NL + "\t\t\tcase ";
  protected final String TEXT_157 = ":";
  protected final String TEXT_158 = NL + "\t\t\t\tfireNotifyChanged(new ";
  protected final String TEXT_159 = "(notification, notification.getNotifier(), false, true));" + NL + "\t\t\t\treturn;";
  protected final String TEXT_160 = "(notification, notification.getNotifier(), true, false));" + NL + "\t\t\t\treturn;";
  protected final String TEXT_161 = "(notification, notification.getNotifier(), true, true));" + NL + "\t\t\t\treturn;";
  protected final String TEXT_162 = NL + "\t\t}";
  protected final String TEXT_163 = NL + "\t\tsuper.notifyChanged(notification);" + NL + "\t}" + NL;
  protected final String TEXT_164 = NL + "\t/**" + NL + "\t * This adds {@link org.eclipse.emf.edit.command.CommandParameter}s describing the children" + NL + "\t * that can be created under this object." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_165 = NL + "\tprotected void collectNewChildDescriptors(";
  protected final String TEXT_166 = " newChildDescriptors, Object object)" + NL + "\t{" + NL + "\t\tsuper.collectNewChildDescriptors(newChildDescriptors, object);";
  ...
  protected final String TEXT_185 = NL + "\t    \t\t" + NL + "\t\t// For all other commands get the original one" + NL + "\t\tCommand originalCommand = super.createCommand(object, domain, commandClass, commandParameter);" + NL + "\t\t";
  protected final String TEXT_186 = NL + "\t\t// In case we try to set the value we also want to make sure that the override attribute gets set" + NL + "\t\tif (commandClass == SetCommand.class && commandParameter.getEAttribute() == PropertyinstancesPackage.Literals.VALUE_PROPERTY_INSTANCE__VALUE) {" + NL + "\t\t\tCommand setOverrideCommand = SetCommand.create(domain, object, InheritancePackage.Literals.IOVERRIDABLE_INHERITANCE_LINK__OVERRIDE, true);" + NL + "\t\t\tCompoundCommand setValueAndOverrideCommand = new CompoundCommand(\"Set Value and Override\");" + NL + "\t\t\tsetValueAndOverrideCommand.append(setOverrideCommand);" + NL + "\t\t\tsetValueAndOverrideCommand.append(originalCommand);" + NL + "\t\t\treturn setValueAndOverrideCommand;" + NL + "\t    }" + NL + "\t    ";
  protected final String TEXT_187 = "\t\t" + NL + "\t    ";
  protected final String TEXT_188 = NL + "\t\t// In case we try to set the value we also want to make sure that the override attribute gets set" + NL + "\t\tif (commandClass == SetCommand.class && commandParameter.getEAttribute() == PropertyinstancesPackage.Literals.RESOURCE_PROPERTY_INSTANCE__RESOURCE_URI) {" + NL + "\t\t\tCommand setOverrideCommand = SetCommand.create(domain, object, InheritancePackage.Literals.IOVERRIDABLE_INHERITANCE_LINK__OVERRIDE, true);" + NL + "\t\t\tCompoundCommand setValueAndOverrideCommand = new CompoundCommand(\"Set Value and Override\");" + NL + "\t\t\tsetValueAndOverrideCommand.append(setOverrideCommand);" + NL + "\t\t\tsetValueAndOverrideCommand.append(originalCommand);" + NL + "\t\t\treturn setValueAndOverrideCommand;" + NL + "\t    }" + NL + "\t    ";
  protected final String TEXT_189 = NL + "\t    ";
  protected final String TEXT_190 = NL + "\t\t// In case we try to set the value we also want to make sure that the override attribute gets set" + NL + "\t\tif (commandClass == SetCommand.class && commandParameter.getEReference() == PropertyinstancesPackage.Literals.REFERENCE_PROPERTY_INSTANCE__REFERENCE) {" + NL + "\t\t\tCommand setOverrideCommand = SetCommand.create(domain, object, InheritancePackage.Literals.IOVERRIDABLE_INHERITANCE_LINK__OVERRIDE, true);" + NL + "\t\t\tCompoundCommand setValueAndOverrideCommand = new CompoundCommand(\"Set Value and Override\");" + NL + "\t\t\tsetValueAndOverrideCommand.append(setOverrideCommand);" + NL + "\t\t\tsetValueAndOverrideCommand.append(originalCommand);" + NL + "\t\t\treturn setValueAndOverrideCommand;" + NL + "\t    }" + NL + "\t    ";
  protected final String TEXT_191 = NL + "\t\t// In case we try to set the value we also want to make sure that the override attribute gets set" + NL + "\t\tif (commandClass == SetCommand.class && (commandParameter.getEReference() == PropertyinstancesPackage.Literals.IUNIT_PROPERTY_INSTANCE__UNIT || commandParameter.getEAttribute() == PropertyinstancesPackage.Literals.VALUE_PROPERTY_INSTANCE__VALUE)) {" + NL + "\t\t\tCommand setOverrideCommand = SetCommand.create(domain, object, InheritancePackage.Literals.IOVERRIDABLE_INHERITANCE_LINK__OVERRIDE, true);" + NL + "\t\t\tCompoundCommand setValueAndOverrideCommand = new CompoundCommand(\"Set Value and Override\");" + NL + "\t\t\tsetValueAndOverrideCommand.append(setOverrideCommand);" + NL + "\t\t\tsetValueAndOverrideCommand.append(originalCommand);" + NL + "\t\t\treturn setValueAndOverrideCommand;" + NL + "\t    }" + NL + "\t    ";
  protected final String TEXT_192 = NL + "\t\tif (commandClass == SetCommand.class && commandParameter.getFeature() == GeneralPackage.Literals.INAME__NAME) {" + NL + "\t\t\tCategoryAssignment ca = (CategoryAssignment) object;" + NL + "\t\t\tif (ca.isIsInherited()) {" + NL + "\t\t\t\treturn UnexecutableCommand.INSTANCE;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t    ";
  protected final String TEXT_193 = "\t" + NL + "\t\t// A RolemanagementCheckCommand should not necessarily be wrapped into another RoleManagementCheck Command" + NL + "\t\tif (originalCommand instanceof RoleManagementCheckCommand) {" + NL + "\t\t\treturn originalCommand;" + NL + "\t\t} else {" + NL + "\t\t\t// And wrap it into our command checking for the proper access rights" + NL + "\t\t\treturn new RoleManagementCheckCommand(originalCommand, commandParameter, userContext);\t" + NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_194 = NL + "\t/**" + NL + "\t * This returns the label text for {@link org.eclipse.emf.edit.command.CreateChildCommand}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_195 = NL + "\tpublic String getCreateChildText(Object owner, Object feature, Object child, ";
  protected final String TEXT_196 = " selection)" + NL + "\t{" + NL + "\t\tObject childFeature = feature;" + NL + "\t\tObject childObject = child;" + NL;
  protected final String TEXT_197 = NL + "\t\tif (childFeature instanceof ";
  protected final String TEXT_198 = " && ";
  protected final String TEXT_199 = ".isFeatureMap((EStructuralFeature)childFeature))" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_200 = ".Entry entry = (FeatureMap.Entry)childObject;" + NL + "\t\t\tchildFeature = entry.getEStructuralFeature();" + NL + "\t\t\tchildObject = entry.getValue();" + NL + "\t\t}" + NL;
  protected final String TEXT_201 = NL + "\t\tboolean qualify =";
  protected final String TEXT_202 = NL + "\t\t\tchildFeature == ";
  protected final String TEXT_203 = NL + NL + "\t\tif (qualify)" + NL + "\t\t{" + NL + "\t\t\treturn getString" + NL + "\t\t\t\t(\"_UI_CreateChild_text2\",";
  protected final String TEXT_204 = NL + "\t\t\t\t new Object[] { getTypeText(childObject), getFeatureText(childFeature), getTypeText(owner) });" + NL + "\t\t}" + NL + "\t\treturn super.getCreateChildText(owner, feature, child, selection);" + NL + "\t}" + NL;
  protected final String TEXT_205 = NL + "\t/**" + NL + "\t * Return the resource locator for this item provider's resources." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_206 = " getResourceLocator()" + NL + "\t{";
  protected final String TEXT_207 = NL + "\t\treturn ((";
  protected final String TEXT_208 = ")adapterFactory).getResourceLocator();";
  protected final String TEXT_209 = NL + "\t\treturn ";
  protected final String TEXT_210 = ".INSTANCE;";
