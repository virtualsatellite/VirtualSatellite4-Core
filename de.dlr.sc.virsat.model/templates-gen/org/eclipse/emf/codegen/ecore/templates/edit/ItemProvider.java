...
public class ItemProvider
{
  ...
  protected final String TEXT_64 = NL + "\tpublic Object getImage(Object object)" + NL + "\t{" + NL + "\t";
  ...
  protected final String TEXT_120 = NL + "\t/**" + NL + "\t * This returns the label styled text for the adapted class." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_121 = NL + "\tpublic Object getStyledText(Object object)" + NL + "\t{";
  protected final String TEXT_122 = ")object;";
  protected final String TEXT_123 = NL + "\t\treturn new ";
  protected final String TEXT_124 = "(\"\" + ";
  protected final String TEXT_125 = ".getKey()).append(\" -> \", ";
  protected final String TEXT_126 = ".QUALIFIER_STYLER).append(\"\" + ";
  protected final String TEXT_127 = NL + "\t\tString key = crop(\"\" + ";
  protected final String TEXT_128 = NL + "\t\tString key = \"\" + ";
  protected final String TEXT_129 = NL + "\t\tString value = crop(\"\" + ";
  protected final String TEXT_130 = NL + "\t\tString value = \"\" + ";
  protected final String TEXT_131 = "(key).append(\" -> \", ";
  protected final String TEXT_132 = ".QUALIFIER_STYLER).append(value);";
  protected final String TEXT_133 = ")object;" + NL + "\t\treturn new ";
  protected final String TEXT_134 = "(getString(\"_UI_";
  protected final String TEXT_135 = "_type\"), ";
  protected final String TEXT_136 = ".QUALIFIER_STYLER).append(\" \").append(";
  protected final String TEXT_137 = ".toString(";
  protected final String TEXT_138 = "()));";
  protected final String TEXT_139 = NL + "\t\tString label = crop(((";
  protected final String TEXT_140 = "());";
  protected final String TEXT_141 = NL + "\t\tString label = ((";
  protected final String TEXT_142 = NL + "\t\tString label = labelValue == null ? null : labelValue.toString();";
  protected final String TEXT_143 = " styledLabel = new ";
  protected final String TEXT_144 = "();" + NL + "\t\tif (label == null || label.length() == 0) " + NL + "\t\t{" + NL + "\t\t\tstyledLabel.append(getString(\"_UI_";
  protected final String TEXT_145 = ".QUALIFIER_STYLER); ";
  protected final String TEXT_146 = NL + "\t\t} else {" + NL + "\t\t\tstyledLabel.append(getString(\"_UI_";
  protected final String TEXT_147 = ".QUALIFIER_STYLER).append(\" \" + label);";
  protected final String TEXT_148 = NL + "\t\t}" + NL + "\t\treturn styledLabel;";
  protected final String TEXT_149 = "_type\"));";
  protected final String TEXT_150 = NL + "\t}\t";
  protected final String TEXT_151 = NL + NL + "\t/**" + NL + "\t * This handles model notifications by calling {@link #updateChildren} to update any cached" + NL + "\t * children and by creating a viewer notification, which it passes to {@link #fireNotifyChanged}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_152 = NL + "\tpublic void notifyChanged(Notification notification)" + NL + "\t{" + NL + "\t\tupdateChildren(notification);";
  protected final String TEXT_153 = NL + NL + "\t\tswitch (notification.getFeatureID(";
  protected final String TEXT_154 = ".class))" + NL + "\t\t{";
  protected final String TEXT_155 = NL + "\t\t\tcase ";
  protected final String TEXT_156 = ":";
  protected final String TEXT_157 = NL + "\t\t\t\tfireNotifyChanged(new ";
  protected final String TEXT_158 = "(notification, notification.getNotifier(), false, true));" + NL + "\t\t\t\treturn;";
  protected final String TEXT_159 = "(notification, notification.getNotifier(), true, false));" + NL + "\t\t\t\treturn;";
  protected final String TEXT_160 = "(notification, notification.getNotifier(), true, true));" + NL + "\t\t\t\treturn;";
  protected final String TEXT_161 = NL + "\t\t}";
  protected final String TEXT_162 = NL + "\t\tsuper.notifyChanged(notification);" + NL + "\t}" + NL;
  protected final String TEXT_163 = NL + "\t/**" + NL + "\t * This adds {@link org.eclipse.emf.edit.command.CommandParameter}s describing the children" + NL + "\t * that can be created under this object." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_164 = NL + "\tprotected void collectNewChildDescriptors(";
  protected final String TEXT_165 = " newChildDescriptors, Object object)" + NL + "\t{" + NL + "\t\tsuper.collectNewChildDescriptors(newChildDescriptors, object);";
  ...
  protected final String TEXT_171 = ".create";
  ...
  protected final String TEXT_191 = NL + "\t\tif (commandClass == SetCommand.class && commandParameter.getFeature() == GeneralPackage.Literals.INAME__NAME) {" + NL + "\t\t\tCategoryAssignment ca = (CategoryAssignment) object;" + NL + "\t\t\tif (ca.isIsInherited()) {" + NL + "\t\t\t\treturn UnexecutableCommand.INSTANCE;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t    ";
  protected final String TEXT_192 = "\t" + NL + "\t\t// A RolemanagementCheckCommand should not necessarily be wrapped into another RoleManagementCheck Command" + NL + "\t\tif (originalCommand instanceof RoleManagementCheckCommand) {" + NL + "\t\t\treturn originalCommand;" + NL + "\t\t} else {" + NL + "\t\t\t// And wrap it into our command checking for the proper access rights" + NL + "\t\t\treturn new RoleManagementCheckCommand(originalCommand, commandParameter, userContext);\t" + NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_193 = NL + "\t/**" + NL + "\t * This returns the label text for {@link org.eclipse.emf.edit.command.CreateChildCommand}." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_205 = " getResourceLocator()" + NL + "\t{";
  protected final String TEXT_206 = NL + "\t\treturn ((";
  protected final String TEXT_207 = ")adapterFactory).getResourceLocator();";
  protected final String TEXT_208 = NL + "\t\treturn ";
  protected final String TEXT_209 = ".INSTANCE;";
