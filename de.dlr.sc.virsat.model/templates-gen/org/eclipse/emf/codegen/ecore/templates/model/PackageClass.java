...
public class PackageClass
{
  ...
  protected final String TEXT_69 = NL + "\t * @return an initialized instance of ";
  protected final String TEXT_70 = "." + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static ";
  protected final String TEXT_71 = " init()" + NL + "\t{" + NL + "\t\tif (isInited) return (";
  protected final String TEXT_72 = ")";
  protected final String TEXT_73 = ".Registry.INSTANCE.getEPackage(";
  protected final String TEXT_74 = ".eNS_URI);" + NL;
  protected final String TEXT_75 = NL + "\t\tinitializeRegistryHelpers();" + NL;
  protected final String TEXT_76 = NL + "\t\t// Obtain or create and register package" + NL + "\t\t";
  protected final String TEXT_77 = " the";
  protected final String TEXT_78 = " = (";
  protected final String TEXT_79 = ")(";
  protected final String TEXT_80 = ".Registry.INSTANCE.get(eNS_URI) instanceof ";
  protected final String TEXT_81 = " ? ";
  protected final String TEXT_82 = ".Registry.INSTANCE.get(eNS_URI) : new ";
  protected final String TEXT_83 = "());" + NL + "" + NL + "\t\tisInited = true;" + NL;
  protected final String TEXT_84 = NL + "\t\t// Initialize simple dependencies";
  protected final String TEXT_85 = NL + "\t\t";
  protected final String TEXT_86 = ".eINSTANCE.eClass();";
  protected final String TEXT_87 = NL + "\t\t// Obtain or create and register interdependencies";
  protected final String TEXT_88 = ".eNS_URI) instanceof ";
