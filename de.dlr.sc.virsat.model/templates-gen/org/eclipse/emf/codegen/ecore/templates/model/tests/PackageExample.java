...
public class PackageExample
{
  ...
  protected final String TEXT_24 = NL + "\t\t// Register the appropriate resource factory to handle all file extensions." + NL + "\t\t//" + NL + "\t\tresourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put" + NL + "\t\t\t(Resource.Factory.Registry.DEFAULT_EXTENSION, " + NL + "\t\t\t new ";
  protected final String TEXT_25 = "());";
  protected final String TEXT_26 = NL + NL + "\t\t// Register the package to ensure it is available during loading." + NL + "\t\t//" + NL + "\t\tresourceSet.getPackageRegistry().put" + NL + "\t\t\t(";
  protected final String TEXT_27 = ".eNS_URI, " + NL + "\t\t\t ";
  protected final String TEXT_28 = ".eINSTANCE);" + NL + "        " + NL + "\t\t// If there are no arguments, emit an appropriate usage message." + NL + "\t\t//" + NL + "\t\tif (args.length == 0)" + NL + "\t\t{";
  protected final String TEXT_29 = NL + "\t\t\tSystem.out.println(\"Enter a list of file paths or URIs that have content like this:\");";
  protected final String TEXT_30 = NL + "\t\t\ttry" + NL + "\t\t\t{";
  protected final String TEXT_31 = NL + "\t\t\t\t";
  protected final String TEXT_32 = " resource = resourceSet.createResource(";
  protected final String TEXT_33 = ".createURI(\"http:///My.";
  ...
  protected final String TEXT_42 = NL + "\t\t\t\tdocumentRoot.eSet(";
  protected final String TEXT_43 = ", root);";
  protected final String TEXT_44 = NL + "\t\t\t\tdocumentRoot.set";
  protected final String TEXT_45 = "(root);";
  protected final String TEXT_46 = NL + "\t\t\t\tresource.getContents().add(";
  protected final String TEXT_47 = ")";
  protected final String TEXT_48 = "documentRoot);";
  protected final String TEXT_49 = "();" + NL + "\t\t\t\tresource.getContents().add(";
  protected final String TEXT_50 = "root);";
  protected final String TEXT_51 = NL + "\t\t\t\tresource.save(";
  protected final String TEXT_52 = ".out, null);" + NL + "\t\t\t}" + NL + "\t\t\tcatch (";
  protected final String TEXT_53 = " exception) " + NL + "\t\t\t{" + NL + "\t\t\t\texception.printStackTrace();" + NL + "\t\t\t}";
  protected final String TEXT_54 = NL + "\t\t\tSystem.out.println(\"Enter a list of file paths or URIs\");";
  protected final String TEXT_55 = NL + "\t\t}" + NL + "\t\telse" + NL + "\t\t{" + NL + "\t\t\t// Iterate over all the arguments." + NL + "\t\t\t//" + NL + "\t\t\tfor (int i = 0; i < args.length; ++i)" + NL + "\t\t\t{" + NL + "\t\t\t\t// Construct the URI for the instance file." + NL + "\t\t\t\t// The argument is treated as a file path only if it denotes an existing file." + NL + "\t\t\t\t// Otherwise, it's directly treated as a URL." + NL + "\t\t\t\t//" + NL + "\t\t\t\t";
  protected final String TEXT_56 = " file = new ";
  protected final String TEXT_57 = "(args[i]);" + NL + "\t\t\t\t";
  protected final String TEXT_58 = " uri = file.isFile() ? ";
  protected final String TEXT_59 = ".createFileURI(file.getAbsolutePath()): URI.createURI(args[i]);" + NL + "" + NL + "\t\t\t\ttry" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\t// Demand load resource for this file." + NL + "\t\t\t\t\t//" + NL + "\t\t\t\t\t";
  protected final String TEXT_60 = " resource = resourceSet.getResource(uri, true);" + NL + "\t\t\t\t\tSystem.out.println(\"Loaded \" + uri);";
  protected final String TEXT_61 = NL + NL + "\t\t\t\t\t// Validate the contents of the loaded resource." + NL + "\t\t\t\t\t//";
  protected final String TEXT_62 = NL + "\t\t\t\t\tfor (";
  protected final String TEXT_63 = " eObject : resource.getContents())";
  protected final String TEXT_64 = " j = resource.getContents().iterator(); j.hasNext(); )";
  protected final String TEXT_65 = NL + "\t\t\t\t\t{";
  protected final String TEXT_66 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_67 = " eObject = (";
  protected final String TEXT_68 = ")j.next();";
