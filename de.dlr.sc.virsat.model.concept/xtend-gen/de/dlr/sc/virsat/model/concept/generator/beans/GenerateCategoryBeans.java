  ...
  protected CharSequence declareArrayAttributesSetterAndGetter(final AProperty property, final ImportManager importManager) {
    return new PropertydefinitionsSwitch<CharSequence>() {
      ...
      public CharSequence caseEReferenceProperty(final EReferenceProperty property) {
        ...
        importManager.register(TypeSafeArrayInstanceList.class);
        StringConcatenation _builder = new StringConcatenation();
        _builder.append("private IBeanList<BeanPropertyEReference> ");
        String _name = property.getName();
        _builder.append(_name);
        _builder.append(" = new TypeSafeArrayInstanceList<>(BeanPropertyEReference.class);");
        _builder.newLineIfNotEmpty();
        _builder.newLine();
        CharSequence _declareSafeAccessArrayMethod = GenerateCategoryBeans.this.declareSafeAccessArrayMethod(property, importManager);
        _builder.append(_declareSafeAccessArrayMethod);
        _builder.newLineIfNotEmpty();
        _builder.newLine();
        _builder.append("public IBeanList<BeanPropertyEReference> ");
        String _propertyMethodGet = GenerateCategoryBeans.this.propertyMethodGet(property);
        _builder.append(_propertyMethodGet);
        _builder.append("() {");
        _builder.newLineIfNotEmpty();
  ...
  protected CharSequence declareAttributesSetterAndGetter(final AProperty property, final ImportManager importManager) {
    return new PropertydefinitionsSwitch<CharSequence>() {
      ...
      public CharSequence caseComposedProperty(final ComposedProperty property) {
        ...
        String _name_5 = property.getName();
        _builder.append(_name_5, "\t\t");
        _builder.append(".setTypeInstance(propertyInstance.getTypeInstance());");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("}");
        _builder.newLine();
        ...
        _builder.newLine();
        _builder.append("public ");
        String _name_6 = property.getType().getName();
      ...
      public CharSequence caseReferenceProperty(final ReferenceProperty property) {
        ...
        if ((_referenceType instanceof Category)) {
          ...
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          _builder.append("CategoryAssignment ca = (CategoryAssignment) propertyInstance.getReference();");
          _builder.newLine();
          _builder.append("\t");
          _builder.newLine();
          _builder.append("\t");
          _builder.append("if (ca != null) {");
          _builder.newLine();
          _builder.append("\t\t");
          _builder.append("if (");
          String _name_3 = property.getName();
          ...
          _builder.newLineIfNotEmpty();
          _builder.append("\t\t\t");
          String _propertyMethodCreate = GenerateCategoryBeans.this.propertyMethodCreate(property);
          _builder.append(_propertyMethodCreate, "\t\t\t");
          _builder.append("(ca);");
          _builder.newLineIfNotEmpty();
          _builder.append("\t\t");
          _builder.append("}");
          ...
          String _name_4 = property.getName();
          _builder.append(_name_4, "\t\t");
          _builder.append(".setTypeInstance(ca);");
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          ...
          _builder.newLine();
          _builder.append("private void ");
          String _propertyMethodCreate_1 = GenerateCategoryBeans.this.propertyMethodCreate(property);
          _builder.append(_propertyMethodCreate_1);
          _builder.append("(CategoryAssignment ca) {");
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          _builder.append("try {");
          _builder.newLine();
          _builder.append("\t\t");
          _builder.append("BeanCategoryAssignmentFactory beanFactory = new BeanCategoryAssignmentFactory();");
          _builder.newLine();
          _builder.append("\t\t");
          String _name_6 = property.getName();
          _builder.append(_name_6, "\t\t");
          ...
          _builder.append(_name_7, "\t\t");
          _builder.append(") beanFactory.getInstanceFor(ca);");
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          ...
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          _builder.append("CategoryAssignment ca = value.getTypeInstance();");
          _builder.newLine();
          _builder.append("\t");
          _builder.append("return SetCommand.create(ed, propertyInstance, PropertyinstancesPackage.Literals.REFERENCE_PROPERTY_INSTANCE__REFERENCE, ca);");
          _builder.newLine();
          _builder.append("}");
          _builder.newLine();
          _builder.newLine();
          ...
          _builder.append(_propertyMethodSet_1);
          _builder.append("(");
          String _name_12 = property.getReferenceType().getName();
          ...
          _builder.newLine();
          _builder.append("\t\t");
          _builder.append("propertyInstance.setReference(value.getTypeInstance());");
          _builder.newLine();
          _builder.append("\t");
          _builder.append("} else {");
          _builder.newLine();
          _builder.append("\t\t");
          _builder.append("propertyInstance.setReference(null);");
          _builder.newLine();
          _builder.append("\t");
          _builder.append("}");
          _builder.newLine();
          ...
          _builder_1.append(".setATypeInstance(propertyInstance.getReference());");
          _builder_1.newLineIfNotEmpty();
          _builder_1.append("}");
          _builder_1.newLine();
          _builder_1.newLine();
          _builder_1.append("public ");
          String _name_17 = referencedPropertyType.getName();
          ...
          _builder_1.append("\t");
          String _propertyMethodSafeAccess_3 = GenerateCategoryBeans.this.propertyMethodSafeAccess(property);
          _builder_1.append(_propertyMethodSafeAccess_3, "\t");
          _builder_1.append(";");
          _builder_1.newLineIfNotEmpty();
          _builder_1.append("\t");
          _builder_1.append("return ");
          ...
          _builder_1.append("\t");
          _builder_1.append("ReferencePropertyInstance propertyInstance = (ReferencePropertyInstance) helper.getPropertyInstance(\"");
          String _name_19 = property.getName();
          _builder_1.append(_name_19, "\t");
          _builder_1.append("\");");
          _builder_1.newLineIfNotEmpty();
          _builder_1.append("\t");
          _builder_1.append("return SetCommand.create(ed, propertyInstance, PropertyinstancesPackage.Literals.REFERENCE_PROPERTY_INSTANCE__REFERENCE, value.getTypeInstance());");
          _builder_1.newLine();
          _builder_1.append("}");
          _builder_1.newLine();
          _builder_1.newLine();
          ...
          _builder_1.append("\t");
          _builder_1.append("ReferencePropertyInstance propertyInstance = (ReferencePropertyInstance) helper.getPropertyInstance(\"");
          String _name_20 = property.getName();
          _builder_1.append(_name_20, "\t");
          _builder_1.append("\");");
          _builder_1.newLineIfNotEmpty();
          _builder_1.append("\t");
          _builder_1.append("propertyInstance.setReference(value.getTypeInstance());");
          _builder_1.newLine();
          _builder_1.append("}");
          _builder_1.newLine();
          return _builder_1;
      ...
      public CharSequence caseEReferenceProperty(final EReferenceProperty property) {
        ...
        String _name = property.getName();
        _builder.append(_name);
        _builder.append(" = new BeanPropertyEReference();");
        _builder.newLineIfNotEmpty();
        _builder.newLine();
        ...
        String _propertyMethodSet = GenerateCategoryBeans.this.propertyMethodSet(property);
        _builder.append(_propertyMethodSet);
        _builder.append("(EditingDomain ed, EObject value) {");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        String _propertyMethodSafeAccess = GenerateCategoryBeans.this.propertyMethodSafeAccess(property);
        _builder.append(_propertyMethodSafeAccess, "\t");
