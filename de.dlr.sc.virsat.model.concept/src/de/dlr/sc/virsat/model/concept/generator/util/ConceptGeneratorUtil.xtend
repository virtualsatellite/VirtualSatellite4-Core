...
class ConceptGeneratorUtil {
	 ...
	 */
	static def getPropertyId(AProperty property, Category category) {
		return category.name + property.name.toFirstUpper;
	}
	
	/**
	 * This method provides the general DLR file header used in java files
	 */
	static def generateFileHeader() '''
	/*******************************************************************************
	 * Copyright (c) 2008-2019 German Aerospace Center (DLR), Simulation and Software Technology, Germany.
	 *
	 * This program and the accompanying materials are made available under the
	...
	/** */
	static def generateAClassHeader(IDescription descriptiveObject) '''
	/**
	 * Auto Generated Abstract Generator Gap Class
	 * 
	 * Don't Manually modify this class
	 * 
	 * «descriptiveObject.description»
	 * 
	 */	
	'''

	static def generateClassHeader(IDescription descriptiveObject) '''
	/**
