 ...
 * 
 */	
public abstract class AThermalInterfaceList extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.thermal.ThermalInterfaceList";
	...
	public AThermalInterfaceList(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "ThermalInterfaceList");
	 ...
	 */
	public AThermalInterfaceList(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
