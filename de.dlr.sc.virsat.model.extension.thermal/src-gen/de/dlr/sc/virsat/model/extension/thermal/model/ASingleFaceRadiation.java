 ...
 * 
 */	
public abstract class ASingleFaceRadiation extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.thermal.SingleFaceRadiation";
	 ...
	 */
	public ASingleFaceRadiation(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "SingleFaceRadiation");
	 ...
	 */
	public ASingleFaceRadiation(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
