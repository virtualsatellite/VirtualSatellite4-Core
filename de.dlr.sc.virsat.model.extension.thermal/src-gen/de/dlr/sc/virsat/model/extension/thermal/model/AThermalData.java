 ...
 * 
 */	
public abstract class AThermalData extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.thermal.ThermalData";
	...
	public AThermalData(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "ThermalData");
	 ...
	 */
	public AThermalData(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
