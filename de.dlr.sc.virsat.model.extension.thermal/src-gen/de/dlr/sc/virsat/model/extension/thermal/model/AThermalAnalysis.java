 ...
 * 
 */	
public abstract class AThermalAnalysis extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.thermal.ThermalAnalysis";
	...
	public AThermalAnalysis(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "ThermalAnalysis");
	 ...
	 */
	public AThermalAnalysis(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
