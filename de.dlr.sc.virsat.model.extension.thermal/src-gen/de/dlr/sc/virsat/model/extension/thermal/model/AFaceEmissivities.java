 ...
 * 
 */	
public abstract class AFaceEmissivities extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.thermal.FaceEmissivities";
	 ...
	 */
	public AFaceEmissivities(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "FaceEmissivities");
	 ...
	 */
	public AFaceEmissivities(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
