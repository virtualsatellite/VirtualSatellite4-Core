 ...
 * 
 */	
public abstract class ASomeElement extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.thermal.SomeElement";
	 ...
	 */
	public ASomeElement(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "SomeElement");
	 ...
	 */
	public ASomeElement(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
