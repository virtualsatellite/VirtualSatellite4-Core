 ...
 * 
 */	
public abstract class ALoads extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.thermal.Loads";
	 ...
	 */
	public ALoads(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "Loads");
	 ...
	 */
	public ALoads(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
