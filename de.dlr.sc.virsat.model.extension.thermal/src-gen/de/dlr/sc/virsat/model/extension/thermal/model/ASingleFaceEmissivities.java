 ...
 * 
 */	
public abstract class ASingleFaceEmissivities extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.thermal.SingleFaceEmissivities";
	 ...
	 */
	public ASingleFaceEmissivities() {
	}
	 ...
	 */
	public ASingleFaceEmissivities(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "SingleFaceEmissivities");
	 ...
	 */
	public ASingleFaceEmissivities(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
