...
public abstract class AMaterialCollection extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {
	...
	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.thermal.MaterialCollection";
	 ...
	 */
	public AMaterialCollection(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "MaterialCollection");
	 ...
	 */
	public AMaterialCollection(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
