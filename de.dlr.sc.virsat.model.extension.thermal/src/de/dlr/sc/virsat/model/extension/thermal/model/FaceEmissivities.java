 ...
 * 
 */
public class FaceEmissivities extends AFaceEmissivities {
	
	/**
	 * Constructor of Concept Class
	 */
	public FaceEmissivities() {
		super();
	}
	...
	/**
 	 ...
 	 */
	public FaceEmissivities(Concept concept) {
		super(concept);
	}	
	 ...
	 */
	public FaceEmissivities(StructuralElementInstance sei) {
		super(sei);
	}
}
