 ...
 * 
 */
public class SingleFaceEmissivities extends ASingleFaceEmissivities {
	
	/**
	 * Constructor of Concept Class
	 */
	public SingleFaceEmissivities() {
		super();
	}
	...
	/**
 	 ...
 	 */
	public SingleFaceEmissivities(Concept concept) {
		super(concept);
	}	
	 ...
	 */
	public SingleFaceEmissivities(StructuralElementInstance sei) {
		super(sei);
	}
}
