 ...
 * 
 */
public class BoundaryCondition extends ABoundaryCondition {
	...
	/**
 	 ...
 	 */
	public BoundaryCondition(Concept concept) {
		super(concept);
	}	
	 ...
	 */
	public BoundaryCondition(StructuralElementInstance sei) {
		super(sei);
	}
}
