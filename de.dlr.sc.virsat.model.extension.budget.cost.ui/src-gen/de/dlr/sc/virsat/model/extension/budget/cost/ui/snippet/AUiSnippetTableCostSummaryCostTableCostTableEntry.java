...
public abstract class AUiSnippetTableCostSummaryCostTableCostTableEntry extends AUiSnippetArrayInstanceCategoryTable implements IUiSnippet {
	...
	public AUiSnippetTableCostSummaryCostTableCostTableEntry() {
	...
	protected Command createAddCommand(EditingDomain editingDomain, Concept activeConcept) {
		return new CreateAddArrayElementCostTableCommand().create(editingDomain, getArrayInstance(model),  ActiveConceptHelper.getCategory(activeConcept, "CostTableEntry"));
	}
}
