 ...
 * 
 */	
public abstract class AUiSnippetSectionCostType extends AUiSnippetGenericPropertyInstances implements IUiSnippet {
	public AUiSnippetSectionCostType() {
		super("de.dlr.sc.virsat.model.extension.budget.cost", "CostType");
	}
}
