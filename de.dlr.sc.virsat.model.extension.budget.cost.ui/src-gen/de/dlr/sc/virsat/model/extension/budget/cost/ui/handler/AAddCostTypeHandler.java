 ...
 * 
 */	
public abstract class AAddCostTypeHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddCostTypeCommand().create(editingDomain, owner, activeConcept);
	}
}
