...
import de.dlr.sc.virsat.model.extension.budget.cost.model.Interface;
 ...
 * 
 */	
public abstract class ACreateAddInterfaceCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		Interface conceptObject = new Interface(activeConcept);
