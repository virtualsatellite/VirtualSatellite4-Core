...
import de.dlr.sc.virsat.model.extension.budget.cost.model.InterfaceEnd;
 ...
 * 
 */	
public abstract class ACreateAddInterfaceEndCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		InterfaceEnd conceptObject = new InterfaceEnd(activeConcept);
