 ...
 * 
 */	
public abstract class AAddMaterialCostHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddMaterialCostCommand().create(editingDomain, owner, activeConcept);
	}
}
