...
public class TMAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dlr.sc.virsat.requirements.tracing.traceModel.TraceElement <em>Trace Element</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dlr.sc.virsat.requirements.tracing.traceModel.TraceabilityLinkContainer <em>Traceability Link Container</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
