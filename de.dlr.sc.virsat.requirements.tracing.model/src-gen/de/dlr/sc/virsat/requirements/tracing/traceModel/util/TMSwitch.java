...
/**
 */
package de.dlr.sc.virsat.requirements.tracing.traceModel.util;
...
public class TMSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TMPackage.TRACE_ELEMENT: {
				TraceElement traceElement = (TraceElement)theEObject;
				T result = caseTraceElement(traceElement);
				if (result == null) result = caseIUuid(traceElement);
				if (result == null) result = caseIName(traceElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TMPackage.TRACEABILITY_LINK_CONTAINER: {
				TraceabilityLinkContainer traceabilityLinkContainer = (TraceabilityLinkContainer)theEObject;
				T result = caseTraceabilityLinkContainer(traceabilityLinkContainer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Traceability Link Container</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Traceability Link Container</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTraceabilityLinkContainer(TraceabilityLinkContainer object) {
		return null;
	}
