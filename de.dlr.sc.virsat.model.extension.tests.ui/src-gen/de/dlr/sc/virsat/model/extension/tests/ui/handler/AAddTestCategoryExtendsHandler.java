 ...
 * 
 */	
public abstract class AAddTestCategoryExtendsHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTestCategoryExtendsCommand().create(editingDomain, owner, activeConcept);
	}
}
