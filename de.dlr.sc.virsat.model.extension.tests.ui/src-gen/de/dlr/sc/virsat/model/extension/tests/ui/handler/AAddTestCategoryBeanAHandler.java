 ...
 * 
 */	
public abstract class AAddTestCategoryBeanAHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTestCategoryBeanACommand().create(editingDomain, owner, activeConcept);
	}
}
