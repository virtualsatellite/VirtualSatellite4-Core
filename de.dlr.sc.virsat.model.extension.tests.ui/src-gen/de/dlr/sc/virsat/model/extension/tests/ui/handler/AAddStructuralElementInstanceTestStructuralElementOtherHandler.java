 ...
 * 
 */	
public abstract class  AAddStructuralElementInstanceTestStructuralElementOtherHandler extends ATransactionalAddStructuralElementHandler implements IHandler {
	...
	protected String getStructuralElementName() {
		return "TestStructuralElementOther";
	}
}
