 ...
 * 
 */	
public abstract class AAddTestCategoryReferenceHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTestCategoryReferenceCommand().create(editingDomain, owner, activeConcept);
	}
}
