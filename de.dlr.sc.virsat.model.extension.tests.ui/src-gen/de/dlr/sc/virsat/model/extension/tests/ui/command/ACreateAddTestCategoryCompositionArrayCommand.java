 ...
 * 
 */	
public abstract class ACreateAddTestCategoryCompositionArrayCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		TestCategoryCompositionArray conceptObject = new TestCategoryCompositionArray(activeConcept);
