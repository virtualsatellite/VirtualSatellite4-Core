 ...
 * 
 */	
public abstract class AUiSnippetTableTestCategoryCompositionArrayTestCompositionArrayStatic extends AUiSnippetArrayInstanceCategoryTable implements IUiSnippet {

	public AUiSnippetTableTestCategoryCompositionArrayTestCompositionArrayStatic() {
		super("de.dlr.sc.virsat.model.extension.tests",
			"TestCategoryAllProperty",
			"testCompositionArrayStatic",
