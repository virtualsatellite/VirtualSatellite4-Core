 ...
 * 
 */	
public abstract class AAddTestCategoryReferenceArrayHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTestCategoryReferenceArrayCommand().create(editingDomain, owner, activeConcept);
	}
}
