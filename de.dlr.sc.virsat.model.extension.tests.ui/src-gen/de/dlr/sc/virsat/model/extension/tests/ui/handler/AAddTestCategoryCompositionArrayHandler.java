 ...
 * 
 */	
public abstract class AAddTestCategoryCompositionArrayHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTestCategoryCompositionArrayCommand().create(editingDomain, owner, activeConcept);
	}
}
