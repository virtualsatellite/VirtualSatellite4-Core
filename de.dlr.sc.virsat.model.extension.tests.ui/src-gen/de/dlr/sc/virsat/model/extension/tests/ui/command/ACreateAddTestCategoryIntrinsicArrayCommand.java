 ...
 * 
 */	
public abstract class ACreateAddTestCategoryIntrinsicArrayCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		TestCategoryIntrinsicArray conceptObject = new TestCategoryIntrinsicArray(activeConcept);
