 ...
 * 
 */	
public abstract class AAddTestMassParametersHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTestMassParametersCommand().create(editingDomain, owner, activeConcept);
	}
}
