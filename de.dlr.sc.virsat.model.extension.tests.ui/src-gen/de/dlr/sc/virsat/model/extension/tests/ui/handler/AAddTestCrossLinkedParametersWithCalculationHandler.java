 ...
 * 
 */	
public abstract class AAddTestCrossLinkedParametersWithCalculationHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTestCrossLinkedParametersWithCalculationCommand().create(editingDomain, owner, activeConcept);
	}
}
