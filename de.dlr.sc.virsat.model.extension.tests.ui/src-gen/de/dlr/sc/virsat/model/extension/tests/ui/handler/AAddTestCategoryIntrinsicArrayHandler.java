 ...
 * 
 */	
public abstract class AAddTestCategoryIntrinsicArrayHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTestCategoryIntrinsicArrayCommand().create(editingDomain, owner, activeConcept);
	}
}
