 ...
 * 
 */	
public abstract class ACreateAddTestCategoryReferenceArrayCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		TestCategoryReferenceArray conceptObject = new TestCategoryReferenceArray(activeConcept);
