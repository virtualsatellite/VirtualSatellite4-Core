 ...
 * 
 */	
public abstract class AAddMassEquipmentHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddMassEquipmentCommand().create(editingDomain, owner, activeConcept);
	}
}
