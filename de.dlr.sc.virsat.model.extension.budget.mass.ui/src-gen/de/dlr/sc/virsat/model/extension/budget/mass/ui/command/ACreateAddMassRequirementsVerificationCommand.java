 ...
 *******************************************************************************/
package de.dlr.sc.virsat.model.extension.budget.mass.ui.command;
 ...
 * 
 */	
public abstract class ACreateAddMassRequirementsVerificationCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		MassRequirementsVerification conceptObject = new MassRequirementsVerification(activeConcept);
