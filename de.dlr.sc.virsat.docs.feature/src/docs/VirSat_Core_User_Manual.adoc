...
This section shows how to share a local project to an SVN repository.

TODO: Installing SVN connector
...
Now your project is connected to an SVN repository, you can *Commit* and *Update* it (see the section below), and you can give its URL to your collaborators.
