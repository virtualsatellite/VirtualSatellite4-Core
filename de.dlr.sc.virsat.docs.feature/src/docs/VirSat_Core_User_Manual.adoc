...
The Interface can be used in the system diagram to connect system components.
image:chapterModeling/subsectionFEA/InterfaceInTheDiagram.PNG[InterfaceType]
