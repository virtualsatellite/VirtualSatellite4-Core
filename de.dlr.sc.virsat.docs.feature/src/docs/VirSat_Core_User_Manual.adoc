...
{counter:step}.
|You can now modify the generated Excel file, e.g. change Name, Cost o the CostType of the `CostEquipment`. Afterwards it can be reimported to update the Virtual Satellite Model.
