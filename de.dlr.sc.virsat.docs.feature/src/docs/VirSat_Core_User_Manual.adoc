...
If you want to load a project from SVN to work with it in Virtual Satellite, follow the steps below.
...
|{counter:step}.
|Press menu:Context[Check Out] in the context menu of your repository.
