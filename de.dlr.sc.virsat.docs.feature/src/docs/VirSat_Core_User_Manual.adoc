...
NOTE: An example for this in the SI unit system is mass.
...
+
NOTE: An example for this in the SI unit system is speed, 
which is composed over the quantities _Length_ with factor 1 and _Time_ with factor -1. 

In the same fashion QUDV supports the following sorts of _Units_:

Simple Unit:: TBD
Conversion Based Unit:: TBD
Derived Unit:: TBD
Prefixed Unit:: TBD
