...
Now your project is connected to an git repository, you can *Commit* and *Update* it (see <<Updating and committing a shared project>>).
...
|image:chapterSettingUpInfrastructure/import-projects.png[Add Repository]
