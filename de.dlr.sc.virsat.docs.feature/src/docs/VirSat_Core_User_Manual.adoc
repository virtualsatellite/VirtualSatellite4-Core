...
TIP: If you have an STL model of your component, you can choose "GEOMETRY" shape and click btn:[Select / Upload File] to use it. Only STL format is supported. In this case size parameters will be ignored.
...
TIP: To open a view you can use a combination kbd:[ALT+SHIFT+Q], kbd:[Q].
