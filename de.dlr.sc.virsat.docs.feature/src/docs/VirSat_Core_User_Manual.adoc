...
|image:chapterStateMachines/1.png[Add State Machine Concept]
...
|image:chapterStateMachines/2.png[Create AOCS EC]
...
For this add three _ElementConfiguration_, and give them the following names: `CAM`, `THR`, `RW`.
|image:chapterStateMachines/3.png[Create Subcomponents of the System]

|{counter:step}.
|Now create the state machines for any of the system components. In the following a state machine is created for the Camera that shall be used in the science phase of the mission for collecting images data. 

Now you can add a state machine to the component `CAM` in the Navigator with `Context` › `State Machines` › `Add StateMachine`.

|image:chapterStateMachines/4.png[Open Diagram Editor]

|{counter:step}.
|Having created a state machine for the camera, now open the state machine Diagram Editor in the Navigator with `Context` › `Open Diagram Editor`.
|image:chapterStateMachines/5.png[Add State Machine Concept]

|{counter:step}.
|The Diagram Editor shall look as shown in the image. 
|image:chapterStateMachines/6.png[Diagram Editor]
...
|image:chapterStateMachines/7.png[Add State] 

|{counter:step}.
|After creating a `transition` connection in the `Diagram Editor`, you want to create a TransitionTriggerEvent and assign it to the `transition` previously created. 

Go in the Editor in the Navigator with `Context` › `Open Editor` or simply by double clicking on the state machine object in the Navigator.
...
|image:chapterStateMachines/8.png[Open Editor] image:chapterStateMachines/9.png[Add TransitionTriggerEvent]
...
NOTE: Transitions can be created or removed in the Diagram, but also manually in the normal Editor.

|image:chapterStateMachines/10.png[Add State Machine Concept]

|{counter:step}.
|First of all, the concepts State Machines and Product Structure need to be activated in the repository.
|image:chapterStateMachines/11.png[Add State Machine Concept]

|{counter:step}.
|First of all, the concepts State Machines and Product Structure need to be activated in the repository.
|image:chapterStateMachines/12.png[Add State Machine Concept]

|{counter:step}.
|First of all, the concepts State Machines and Product Structure need to be activated in the repository.
|image:chapterStateMachines/13.png[Add State Machine Concept]

|{counter:step}.
|First of all, the concepts State Machines and Product Structure need to be activated in the repository.
|image:chapterStateMachines/14.png[Add State Machine Concept]

|{counter:step}.
|First of all, the concepts State Machines and Product Structure need to be activated in the repository.
|image:chapterStateMachines/15.png[Add State Machine Concept]

|{counter:step}.
|First of all, the concepts State Machines and Product Structure need to be activated in the repository.
|image:chapterStateMachines/16.png[Add State Machine Concept]
|===
