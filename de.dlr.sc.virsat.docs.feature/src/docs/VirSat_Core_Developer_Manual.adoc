...
For most simple changes the auto-generated migrator is sufficient, however if some custom migration logic is required, it can be added to the migrator class.
...
Test plugin contains some auto-generated unit tests. You can add more unit tests as you develop your concept.
