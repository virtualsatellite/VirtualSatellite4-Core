...
By decoupling the engineering domain data from the system model's structure, it is possible to add new concepts to a system model later and to also open system models without all concepts loaded in Virtual Satellite.
