...
import de.dlr.sc.virsat.model.extension.sequencing.model.SequenceEntry;
 ...
 * 
 */	
public abstract class ACreateAddSequenceEntryCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		SequenceEntry conceptObject = new SequenceEntry(activeConcept);
