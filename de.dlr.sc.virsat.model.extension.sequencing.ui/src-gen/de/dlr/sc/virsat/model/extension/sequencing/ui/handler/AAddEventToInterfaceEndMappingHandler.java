 ...
 * 
 */	
public abstract class AAddEventToInterfaceEndMappingHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddEventToInterfaceEndMappingCommand().create(editingDomain, owner, activeConcept);
	}
}
