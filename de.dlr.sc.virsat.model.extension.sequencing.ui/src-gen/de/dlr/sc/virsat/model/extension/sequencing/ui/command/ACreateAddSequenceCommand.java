...
import de.dlr.sc.virsat.model.extension.sequencing.model.Sequence;
 ...
 * 
 */	
public abstract class ACreateAddSequenceCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		Sequence conceptObject = new Sequence(activeConcept);
