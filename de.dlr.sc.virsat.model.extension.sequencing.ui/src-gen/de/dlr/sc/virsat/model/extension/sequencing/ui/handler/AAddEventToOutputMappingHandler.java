 ...
 * 
 */	
public abstract class AAddEventToOutputMappingHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddEventToOutputMappingCommand().create(editingDomain, owner, activeConcept);
	}
}
