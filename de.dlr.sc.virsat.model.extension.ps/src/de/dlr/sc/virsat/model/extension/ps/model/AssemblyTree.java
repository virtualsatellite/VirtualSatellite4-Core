 ...
 * 
 */	
@XmlType(name = AAssemblyTree.FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME)
public class AssemblyTree extends AAssemblyTree {
	...
	/**
 	 ...
 	 */
	public AssemblyTree(Concept concept) {
		super(concept);
	}	
	 ...
	 */
	public AssemblyTree(StructuralElementInstance sei) {
		super(sei);
	}
}
