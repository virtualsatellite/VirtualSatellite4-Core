 ...
 * 
 */	
@XmlType(name = AProductStorageDomain.FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME)
public class ProductStorageDomain extends AProductStorageDomain {
	
	/**
	 * Constructor of Concept Class
	 */
	public ProductStorageDomain() {
		super();
	}
	...
	/**
 	 ...
 	 */
	public ProductStorageDomain(Concept concept) {
		super(concept);
	}	
	 ...
	 */
	public ProductStorageDomain(StructuralElementInstance sei) {
		super(sei);
	}
}
