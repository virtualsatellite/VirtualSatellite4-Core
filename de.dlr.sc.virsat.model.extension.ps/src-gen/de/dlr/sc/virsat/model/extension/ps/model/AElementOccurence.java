 ...
 * 
 */	
public abstract class AElementOccurence extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.ps.ElementOccurence";
	 ...
	 */
	public AElementOccurence(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "ElementOccurence");
	 ...
	 */
	public AElementOccurence(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
