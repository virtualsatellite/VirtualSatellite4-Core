 ...
 * 
 */	
public abstract class AConfigurationTree extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.ps.ConfigurationTree";
	 ...
	 */
	public AConfigurationTree(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "ConfigurationTree");
	 ...
	 */
	public AConfigurationTree(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
