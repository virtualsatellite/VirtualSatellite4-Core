 ...
 * 
 */	
public abstract class AProductTree extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.ps.ProductTree";
	 ...
	 */
	public AProductTree(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "ProductTree");
	 ...
	 */
	public AProductTree(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
