 ...
 * 
 */	
public abstract class AAssemblyTree extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.ps.AssemblyTree";
	 ...
	 */
	public AAssemblyTree(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "AssemblyTree");
	 ...
	 */
	public AAssemblyTree(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
