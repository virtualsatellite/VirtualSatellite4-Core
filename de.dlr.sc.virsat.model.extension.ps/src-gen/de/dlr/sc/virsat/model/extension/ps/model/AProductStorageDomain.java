 ...
 * 
 */	
public abstract class AProductStorageDomain extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.ps.ProductStorageDomain";
	 ...
	 */
	public AProductStorageDomain(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "ProductStorageDomain");
	 ...
	 */
	public AProductStorageDomain(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
