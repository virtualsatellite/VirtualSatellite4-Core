 ...
 * 
 */	
public abstract class AProductTreeDomain extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.ps.ProductTreeDomain";
	 ...
	 */
	public AProductTreeDomain(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "ProductTreeDomain");
	 ...
	 */
	public AProductTreeDomain(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
