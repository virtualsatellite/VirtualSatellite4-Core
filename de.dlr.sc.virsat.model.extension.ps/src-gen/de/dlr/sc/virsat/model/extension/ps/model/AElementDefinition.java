 ...
 * 
 */	
public abstract class AElementDefinition extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.ps.ElementDefinition";
	 ...
	 */
	public AElementDefinition(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "ElementDefinition");
	 ...
	 */
	public AElementDefinition(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
