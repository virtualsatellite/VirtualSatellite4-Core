 ...
 * 
 */	
public abstract class AProductStorage extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.ps.ProductStorage";
	 ...
	 */
	public AProductStorage(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "ProductStorage");
	 ...
	 */
	public AProductStorage(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
