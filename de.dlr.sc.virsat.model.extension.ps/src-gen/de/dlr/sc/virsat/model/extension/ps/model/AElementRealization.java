 ...
 * 
 */	
public abstract class AElementRealization extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.ps.ElementRealization";
	 ...
	 */
	public AElementRealization(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "ElementRealization");
	 ...
	 */
	public AElementRealization(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
