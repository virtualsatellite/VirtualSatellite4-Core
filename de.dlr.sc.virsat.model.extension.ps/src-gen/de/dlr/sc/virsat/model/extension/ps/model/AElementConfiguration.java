 ...
 * 
 */	
public abstract class AElementConfiguration extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.ps.ElementConfiguration";
	...
	public AElementConfiguration(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "ElementConfiguration");
	 ...
	 */
	public AElementConfiguration(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
