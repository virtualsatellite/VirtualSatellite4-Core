 ...
 * 
 */
public class LowerLimitVerificationStepTest extends AConceptProjectTestCase {
	...
	public class TestLowerLimitRequirementsVerification extends LowerLimitVerification {
		boolean statusCompliant = false;
		boolean statusOpen = false;
		boolean statusNonCompliant = false;
		boolean statusPartlyCompliant = false;
		
		public TestLowerLimitRequirementsVerification() {
	...
	public void testRunCustomVerificationNoTrace() {
		TestLowerLimitRequirementsVerification testObject = new TestLowerLimitRequirementsVerification();
	...
	public void testRunCustomVerificationCompliant() {
		...
		TestLowerLimitRequirementsVerification testVerification = new TestLowerLimitRequirementsVerification();
