 ...
 * 
 */	
public abstract class AAddUpperLimitVerificationHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddUpperLimitVerificationCommand().create(editingDomain, owner, activeConcept);
	}
}
