 ...
 * 
 */	
public abstract class AAddRequirementLinkHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddRequirementLinkCommand().create(editingDomain, owner, activeConcept);
	}
}
