 ...
 * 
 */	
public abstract class ACreateAddSynchronizationConfigurationCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		SynchronizationConfiguration conceptObject = new SynchronizationConfiguration(activeConcept);
