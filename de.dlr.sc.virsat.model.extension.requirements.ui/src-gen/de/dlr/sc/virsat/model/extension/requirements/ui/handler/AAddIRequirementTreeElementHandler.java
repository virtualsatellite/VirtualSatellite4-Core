 ...
 * 
 */	
public abstract class AAddIRequirementTreeElementHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddIRequirementTreeElementCommand().create(editingDomain, owner, activeConcept);
	}
}
