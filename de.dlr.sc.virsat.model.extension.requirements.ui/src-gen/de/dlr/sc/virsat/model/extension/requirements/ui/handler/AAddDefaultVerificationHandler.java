 ...
 * 
 */	
public abstract class AAddDefaultVerificationHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddDefaultVerificationCommand().create(editingDomain, owner, activeConcept);
	}
}
