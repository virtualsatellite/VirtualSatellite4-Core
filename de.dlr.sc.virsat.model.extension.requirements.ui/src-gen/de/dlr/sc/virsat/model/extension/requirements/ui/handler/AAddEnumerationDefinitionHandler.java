 ...
 * 
 */	
public abstract class AAddEnumerationDefinitionHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddEnumerationDefinitionCommand().create(editingDomain, owner, activeConcept);
	}
}
