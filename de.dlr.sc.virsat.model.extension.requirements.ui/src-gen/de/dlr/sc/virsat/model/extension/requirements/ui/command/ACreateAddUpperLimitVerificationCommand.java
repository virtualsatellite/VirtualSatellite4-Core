...
import de.dlr.sc.virsat.model.extension.requirements.model.UpperLimitVerification;
 ...
 * 
 */	
public abstract class ACreateAddUpperLimitVerificationCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		UpperLimitVerification conceptObject = new UpperLimitVerification(activeConcept);
