 ...
 * 
 */	
public abstract class AAddAttributeValueHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddAttributeValueCommand().create(editingDomain, owner, activeConcept);
	}
}
