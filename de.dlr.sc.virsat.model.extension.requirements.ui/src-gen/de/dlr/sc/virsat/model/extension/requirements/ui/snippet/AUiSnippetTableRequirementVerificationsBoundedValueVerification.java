 ...
 * 
 */	
public abstract class AUiSnippetTableRequirementVerificationsBoundedValueVerification extends AUiSnippetArrayInstanceCategoryTable implements IUiSnippet {
	...
	protected Command createAddCommand(EditingDomain editingDomain, Concept activeConcept) {
		return new CreateAddArrayElementVerificationsCommand().create(editingDomain, getArrayInstance(model),  ActiveConceptHelper.getCategory(activeConcept, "BoundedValueVerification"));
	}
}
