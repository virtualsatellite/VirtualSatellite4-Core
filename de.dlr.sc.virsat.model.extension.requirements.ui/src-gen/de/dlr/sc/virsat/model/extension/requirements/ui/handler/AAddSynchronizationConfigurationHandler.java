 ...
 * 
 */	
public abstract class AAddSynchronizationConfigurationHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddSynchronizationConfigurationCommand().create(editingDomain, owner, activeConcept);
	}
}
