 ...
 * 
 */	
public abstract class AUiSnippetTableRequirementLinkType extends AUiSnippetGenericCategoryAssignmentTable implements IUiSnippet {
	public AUiSnippetTableRequirementLinkType() {
	...
	protected Command createAddCommand(EditingDomain editingDomain, Concept activeConcept) {
		return new CreateAddRequirementLinkTypeCommand().create(editingDomain, model, activeConcept);
	}
}
