 ...
 * 
 */	
public abstract class AAddVerificationConfigurationHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddVerificationConfigurationCommand().create(editingDomain, owner, activeConcept);
	}
}
