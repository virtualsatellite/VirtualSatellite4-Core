 ...
 * 
 */	
public abstract class AAddRequirementAttributeHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddRequirementAttributeCommand().create(editingDomain, owner, activeConcept);
	}
}
