 ...
 * 
 */	
public abstract class AUiSnippetTableSpecificationMapping extends AUiSnippetGenericCategoryAssignmentTable implements IUiSnippet {
	public AUiSnippetTableSpecificationMapping() {
	...
	protected Command createAddCommand(EditingDomain editingDomain, Concept activeConcept) {
		return new CreateAddSpecificationMappingCommand().create(editingDomain, model, activeConcept);
	}
}
