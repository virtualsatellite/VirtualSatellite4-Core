 ...
 * 
 */	
public abstract class  AAddStructuralElementInstanceRequirementsConfigurationCollectionHandler extends ATransactionalAddStructuralElementHandler implements IHandler {
	...
	protected String getStructuralElementName() {
		return "RequirementsConfigurationCollection";
	}
}
