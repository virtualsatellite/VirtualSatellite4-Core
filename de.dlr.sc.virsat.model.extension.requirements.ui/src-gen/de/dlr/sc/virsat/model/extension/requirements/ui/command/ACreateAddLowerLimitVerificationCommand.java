...
import de.dlr.sc.virsat.model.extension.requirements.model.LowerLimitVerification;
 ...
 * 
 */	
public abstract class ACreateAddLowerLimitVerificationCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		LowerLimitVerification conceptObject = new LowerLimitVerification(activeConcept);
