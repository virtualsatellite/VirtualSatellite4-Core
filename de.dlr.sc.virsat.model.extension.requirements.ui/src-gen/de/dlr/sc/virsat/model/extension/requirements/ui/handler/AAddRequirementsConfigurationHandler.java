 ...
 * 
 */	
public abstract class AAddRequirementsConfigurationHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddRequirementsConfigurationCommand().create(editingDomain, owner, activeConcept);
	}
}
