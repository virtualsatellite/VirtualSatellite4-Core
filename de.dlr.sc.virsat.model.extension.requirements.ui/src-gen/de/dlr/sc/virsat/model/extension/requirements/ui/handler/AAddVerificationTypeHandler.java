 ...
 * 
 */	
public abstract class AAddVerificationTypeHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddVerificationTypeCommand().create(editingDomain, owner, activeConcept);
	}
}
