 ...
 * 
 */	
public abstract class AAddLowerLimitVerificationHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddLowerLimitVerificationCommand().create(editingDomain, owner, activeConcept);
	}
}
