 ...
 * 
 */	
public abstract class AAddBoundedValueVerificationHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddBoundedValueVerificationCommand().create(editingDomain, owner, activeConcept);
	}
}
