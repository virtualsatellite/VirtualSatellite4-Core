 ...
 * 
 */	
public abstract class AAddExistenceVerificationHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddExistenceVerificationCommand().create(editingDomain, owner, activeConcept);
	}
}
