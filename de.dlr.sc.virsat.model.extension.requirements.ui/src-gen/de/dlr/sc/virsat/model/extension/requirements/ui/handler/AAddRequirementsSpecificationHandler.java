 ...
 * 
 */	
public abstract class AAddRequirementsSpecificationHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddRequirementsSpecificationCommand().create(editingDomain, owner, activeConcept);
	}
}
