 ...
 * 
 */	
public abstract class AAddRequirementsViewHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddRequirementsViewCommand().create(editingDomain, owner, activeConcept);
	}
}
