 ...
 * 
 */	
public abstract class AAddRequirementGroupHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddRequirementGroupCommand().create(editingDomain, owner, activeConcept);
	}
}
