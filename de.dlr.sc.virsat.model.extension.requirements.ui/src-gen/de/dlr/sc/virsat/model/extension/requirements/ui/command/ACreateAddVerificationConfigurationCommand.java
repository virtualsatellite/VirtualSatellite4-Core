...
import de.dlr.sc.virsat.model.extension.requirements.model.VerificationConfiguration;
 ...
 * 
 */	
public abstract class ACreateAddVerificationConfigurationCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		VerificationConfiguration conceptObject = new VerificationConfiguration(activeConcept);
