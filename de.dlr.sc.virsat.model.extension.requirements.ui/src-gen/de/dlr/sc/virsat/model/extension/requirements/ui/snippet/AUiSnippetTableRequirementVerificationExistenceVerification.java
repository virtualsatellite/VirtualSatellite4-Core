 ...
 * 
 */	
public abstract class AUiSnippetTableRequirementVerificationExistenceVerification extends AUiSnippetArrayInstanceCategoryTable implements IUiSnippet {

	public AUiSnippetTableRequirementVerificationExistenceVerification() {
	...
	protected Command createAddCommand(EditingDomain editingDomain, Concept activeConcept) {
		return new CreateAddArrayElementVerificationCommand().create(editingDomain, getArrayInstance(model),  ActiveConceptHelper.getCategory(activeConcept, "ExistenceVerification"));
	}
}
