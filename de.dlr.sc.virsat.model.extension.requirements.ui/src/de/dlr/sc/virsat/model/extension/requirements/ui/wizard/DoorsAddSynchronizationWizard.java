...
/**
 * A wizard for the synchronization with Doors requirements by adding a new synchronization configuration
 *
 */
public class DoorsAddSynchronizationWizard extends Wizard implements IWorkbenchWizard {
	...
	private DoorsAddSynchroConfigurationPage addSynchroPage;
	 ...
	 * Default constructor
	 */
	public DoorsAddSynchronizationWizard() {
		super();
	...
	public boolean canFinish() {
		return super.canFinish() || addSynchroPage.canFinish();
	}
...
//				importSubMonitor.worked(1);
	...
	public void addPages() {
		...
		addSynchroPage = new DoorsAddSynchroConfigurationPage(model, importPage);
		addPage(importPage);
		addPage(addSynchroPage);
	}
