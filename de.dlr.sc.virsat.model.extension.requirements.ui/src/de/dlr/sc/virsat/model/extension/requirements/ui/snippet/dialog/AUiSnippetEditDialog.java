...
/**
 * Dialog using editor snippets to modify a model element
 *
 */
public abstract class AUiSnippetEditDialog extends Dialog {
	 ...
	 */
	public AUiSnippetEditDialog(Shell parent, EditingDomain editingDomain, EObject initModel) {
		super(parent);
