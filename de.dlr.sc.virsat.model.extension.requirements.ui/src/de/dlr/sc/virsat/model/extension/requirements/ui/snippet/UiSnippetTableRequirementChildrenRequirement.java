 ...
 * 
 */
public class UiSnippetTableRequirementChildrenRequirement extends UiSnippetCustomRequirementsAttributeTable implements IUiSnippet {
	
	/**
	 * 
	 */
	public UiSnippetTableRequirementChildrenRequirement() {
