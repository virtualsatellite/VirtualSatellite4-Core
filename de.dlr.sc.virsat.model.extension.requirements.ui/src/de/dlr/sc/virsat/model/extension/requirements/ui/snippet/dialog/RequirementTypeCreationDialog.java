...
public class RequirementTypeCreationDialog extends Dialog {
	 ...
	 */
	public RequirementTypeCreationDialog(Shell parentShell, FormToolkit toolkit, EditingDomain editingDomain, EObject initModel) {
		super(parentShell);
	...
	protected Control createContents(Composite parent) {
		...
		new UiSnippetTableRequirementTypeAttributesRequirementAttribute().createSwt(toolkit, editingDomain, parent, initModel);
