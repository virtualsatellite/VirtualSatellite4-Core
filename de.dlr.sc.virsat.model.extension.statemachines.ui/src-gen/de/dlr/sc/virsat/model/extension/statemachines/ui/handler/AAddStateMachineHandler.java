 ...
 * 
 */	
public abstract class AAddStateMachineHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddStateMachineCommand().create(editingDomain, owner, activeConcept);
	}
}
