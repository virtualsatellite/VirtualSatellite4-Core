 ...
 * 
 */	
public abstract class AUiSnippetTableStateMachineConstraintsForbidsConstraint extends AUiSnippetArrayInstanceCategoryTable implements IUiSnippet {

	public AUiSnippetTableStateMachineConstraintsForbidsConstraint() {
	...
	protected Command createAddCommand(EditingDomain editingDomain, Concept activeConcept) {
		return new CreateAddArrayElementConstraintsCommand().create(editingDomain, getArrayInstance(model),  ActiveConceptHelper.getCategory(activeConcept, "ForbidsConstraint"));
	}
}
