 ...
 * 
 */	
public abstract class AAddForbidsConstraintHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddForbidsConstraintCommand().create(editingDomain, owner, activeConcept);
	}
}
