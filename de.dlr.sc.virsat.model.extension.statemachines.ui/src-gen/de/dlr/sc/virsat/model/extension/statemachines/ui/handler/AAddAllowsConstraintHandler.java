 ...
 * 
 */	
public abstract class AAddAllowsConstraintHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddAllowsConstraintCommand().create(editingDomain, owner, activeConcept);
	}
}
