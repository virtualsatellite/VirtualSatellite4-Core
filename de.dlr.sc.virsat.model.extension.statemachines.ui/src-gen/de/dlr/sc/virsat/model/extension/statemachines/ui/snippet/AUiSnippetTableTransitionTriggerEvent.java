 ...
 * 
 */	
public abstract class AUiSnippetTableTransitionTriggerEvent extends AUiSnippetGenericCategoryAssignmentTable implements IUiSnippet {
	public AUiSnippetTableTransitionTriggerEvent() {
	...
	protected Command createAddCommand(EditingDomain editingDomain, Concept activeConcept) {
		return new CreateAddTransitionTriggerEventCommand().create(editingDomain, model, activeConcept);
	}
}
