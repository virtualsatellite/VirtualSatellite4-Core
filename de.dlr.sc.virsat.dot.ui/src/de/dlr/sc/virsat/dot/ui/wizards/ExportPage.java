...
public class ExportPage extends WizardPage {
	...
	private static final String DIALOG_DEFAULT_FILE_NAME = "file.dot";
	private static final String[] DIALOG_EXTENSIONS = { "*.dot" };
	...
	private void createTreeUI() {
		...
		TreeViewer treeViewer = new TreeViewer(content, SWT.MULTI);
