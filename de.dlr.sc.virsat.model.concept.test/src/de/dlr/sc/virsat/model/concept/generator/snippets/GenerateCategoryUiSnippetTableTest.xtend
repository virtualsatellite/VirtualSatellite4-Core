...
class GenerateCategoryUiSnippetTableTest {
	...
	val generator = new GenerateCategoryUiSnippetTable
    ...
    def void testCreateConcreteClassFileName() {
    	...
    	val expectedFileName = "../../" + testConceptName + ".ui/src/" + testConceptName + "/ui/snippet/UiSnippetTable" + testCategoryName.toFirstUpper + ".java"
    ...
    def void testCreateAbstractClassFileName() {
    	...
    	val expectedFileName = "../../" + testConceptName + ".ui/src-gen/" + testConceptName + "/ui/snippet/AUiSnippetTable" + testCategoryName.toFirstUpper + ".java"
