...
public class GenerateCategoryTestsTest {
  @Inject
  @Extension
  ...
  private final GenerateCategoryTests generateCategoryTests = new GenerateCategoryTests();
  ...
  public void testCreateConcreteClassFileName() {
    try {
      ...
      final String concreteClassfileName = this.generateCategoryTests.createConcreteClassFileName(this.concept, category);
      final String abstractClassfileName = this.generateCategoryTests.createAbstractClassFileName(this.concept, category);
      final String expectedConcreteClassFileName = "../../testConcept.test/src/testConcept/model/TestCategoryTest.java";
      final String expectedAbstractClassFileName = "../../testConcept.test/src-gen/testConcept/model/ATestCategoryTest.java";
  ...
  public void testCreateForCategoryTests() {
    try {
      ...
      this.concept = this._parseHelper.parse(_builder);
      final Category category = this.concept.getCategories().get(0);
      final CharSequence concreteClassContents = this.generateCategoryTests.createConcreteClass(this.concept, category);
      final CharSequence abstractClassContents = this.generateCategoryTests.createAbstractClass(this.concept, category);
