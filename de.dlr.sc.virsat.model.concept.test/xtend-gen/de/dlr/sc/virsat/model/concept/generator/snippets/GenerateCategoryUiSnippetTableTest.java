...
public class GenerateCategoryUiSnippetTableTest {
  @Inject
  @Extension
  ...
  private final GenerateCategoryUiSnippetTable generator = new GenerateCategoryUiSnippetTable();
  ...
  public void testCreateConcreteClassFileName() {
    ...
    String _plus = ((((("../../" + this.testConceptName) + ".ui/src/") + this.testConceptName) + "/ui/snippet/UiSnippetTable") + _firstUpper);
  ...
  public void testCreateAbstractClassFileName() {
    ...
    String _firstUpper = StringExtensions.toFirstUpper(this.testCategoryName);
    String _plus = ((((("../../" + this.testConceptName) + ".ui/src-gen/") + this.testConceptName) + "/ui/snippet/AUiSnippetTable") + _firstUpper);
    final String expectedFileName = (_plus + ".java");
  ...
  public void testCreateConcreteClass() {
    try {
      ...
      GeneratorJunitAssert.assertEqualContent(classContents, "/resources/expectedOutputFilesForGenerators/UiSnippetTable.java");
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
  ...
  public void testCreateAbstractClass() {
    try {
      ...
      GeneratorJunitAssert.assertEqualContent(classContents, "/resources/expectedOutputFilesForGenerators/AUiSnippetTable.java");
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
