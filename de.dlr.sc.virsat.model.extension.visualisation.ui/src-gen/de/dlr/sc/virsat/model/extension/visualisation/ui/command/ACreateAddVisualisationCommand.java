 ...
 *******************************************************************************/
package de.dlr.sc.virsat.model.extension.visualisation.ui.command;
 ...
 * 
 */	
public abstract class ACreateAddVisualisationCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		Visualisation conceptObject = new Visualisation(activeConcept);
