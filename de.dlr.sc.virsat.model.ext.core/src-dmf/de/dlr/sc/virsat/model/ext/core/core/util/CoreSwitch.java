...
public class CoreSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CorePackage.GENERIC_CATEGORY: {
				GenericCategory genericCategory = (GenericCategory)theEObject;
				T result = caseGenericCategory(genericCategory);
				if (result == null) result = caseDObject(genericCategory);
				if (result == null) result = caseIUuid(genericCategory);
				if (result == null) result = caseIName(genericCategory);
