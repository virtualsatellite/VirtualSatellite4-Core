...
import de.dlr.sc.virsat.model.extension.funcelectrical.model.ThermalReferencePoint;
 ...
 * 
 */	
public abstract class ACreateAddThermalReferencePointCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		ThermalReferencePoint conceptObject = new ThermalReferencePoint(activeConcept);
