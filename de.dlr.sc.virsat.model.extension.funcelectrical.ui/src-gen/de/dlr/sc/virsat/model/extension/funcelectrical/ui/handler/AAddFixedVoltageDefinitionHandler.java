 ...
 * 
 */	
public abstract class AAddFixedVoltageDefinitionHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddFixedVoltageDefinitionCommand().create(editingDomain, owner, activeConcept);
	}
}
