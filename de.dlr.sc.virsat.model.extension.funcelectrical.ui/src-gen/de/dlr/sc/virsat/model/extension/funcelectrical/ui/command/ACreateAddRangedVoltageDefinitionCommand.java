...
import de.dlr.sc.virsat.model.extension.funcelectrical.model.RangedVoltageDefinition;
 ...
 * 
 */	
public abstract class ACreateAddRangedVoltageDefinitionCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		RangedVoltageDefinition conceptObject = new RangedVoltageDefinition(activeConcept);
