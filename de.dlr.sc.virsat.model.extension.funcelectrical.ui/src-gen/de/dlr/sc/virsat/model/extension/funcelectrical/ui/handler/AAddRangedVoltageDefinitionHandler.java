 ...
 * 
 */	
public abstract class AAddRangedVoltageDefinitionHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddRangedVoltageDefinitionCommand().create(editingDomain, owner, activeConcept);
	}
}
