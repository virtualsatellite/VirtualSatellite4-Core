 ...
 * 
 */	
public abstract class AAddPowerInterfaceTypeHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddPowerInterfaceTypeCommand().create(editingDomain, owner, activeConcept);
	}
}
