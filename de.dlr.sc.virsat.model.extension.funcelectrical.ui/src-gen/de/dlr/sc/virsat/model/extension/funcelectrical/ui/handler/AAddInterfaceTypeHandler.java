 ...
 * 
 */	
public abstract class AAddInterfaceTypeHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddInterfaceTypeCommand().create(editingDomain, owner, activeConcept);
	}
}
