 ...
 * 
 */	
public abstract class AAddThermalReferencePointHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddThermalReferencePointCommand().create(editingDomain, owner, activeConcept);
	}
}
