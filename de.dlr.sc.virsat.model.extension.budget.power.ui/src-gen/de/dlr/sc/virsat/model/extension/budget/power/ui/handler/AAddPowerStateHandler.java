 ...
 * 
 */	
public abstract class AAddPowerStateHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddPowerStateCommand().create(editingDomain, owner, activeConcept);
	}
}
