 ...
 *******************************************************************************/
package de.dlr.sc.virsat.model.extension.budget.power.ui.command;
 ...
 * 
 */	
public abstract class ACreateAddPowerEquipmentCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		PowerEquipment conceptObject = new PowerEquipment(activeConcept);
