 ...
 * 
 */	
public abstract class ATestStructuralElement extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.tests.TestStructuralElement";
	 ...
	 */
	public ATestStructuralElement(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "TestStructuralElement");
	 ...
	 */
	public ATestStructuralElement(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
