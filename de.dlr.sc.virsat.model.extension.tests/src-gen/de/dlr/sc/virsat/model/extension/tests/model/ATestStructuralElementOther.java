 ...
 * 
 */	
public abstract class ATestStructuralElementOther extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.tests.TestStructuralElementOther";
	 ...
	 */
	public ATestStructuralElementOther() {
	}
	 ...
	 */
	public ATestStructuralElementOther(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "TestStructuralElementOther");
	 ...
	 */
	public ATestStructuralElementOther(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
