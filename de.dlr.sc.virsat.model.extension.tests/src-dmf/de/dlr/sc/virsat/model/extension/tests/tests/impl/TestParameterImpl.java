 ...
 * </p>
 * <ul>
 *   <li>{@link de.dlr.sc.virsat.model.extension.tests.tests.impl.TestParameterImpl#getDefaultValue <em>Default Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TestParameterImpl extends GenericCategoryImpl implements TestParameter {
	/**
	...
	protected EClass eStaticClass() {
		return TestsPackage.Literals.TEST_PARAMETER;
	}
	...
	public void setDefaultValue(double newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestsPackage.TEST_PARAMETER__DEFAULT_VALUE, oldDefaultValue, defaultValue));
	}
