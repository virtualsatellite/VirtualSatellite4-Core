 ...
 * 
 */	
@XmlType(name = AInterfaceTypeCollection.FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME)
public class InterfaceTypeCollection extends AInterfaceTypeCollection {
	
	/**
	 * Constructor of Concept Class
	 */
	public InterfaceTypeCollection() {
		super();
	}
	 ...
	 */
	public InterfaceTypeCollection(StructuralElementInstance sei) {
		super(sei);
	}
	 ...
	 */
	public InterfaceTypeCollection(Concept concept) {
		super(concept);
	}
}
