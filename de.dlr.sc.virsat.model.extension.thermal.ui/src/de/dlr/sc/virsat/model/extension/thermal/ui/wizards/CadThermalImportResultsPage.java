 ...
 *
 */
public class CadThermalImportResultsPage extends AImportExportPage {

	/**
	 * Standard constructor
	 * @param model the root model
	 */
	protected CadThermalImportResultsPage(IContainer model) {
		super("CAD Thermal Results Import");
		setTitle("CAD Thermal Results Import (Beta)");
		setModel(model);
		setDescription("Please select a thermal analysis results to import and a tree model element as parent of the results element.");
	}
