 ...
 * 
 */	
public abstract class AUiSnippetTableThermalAnalysis extends AUiSnippetGenericCategoryAssignmentTable implements IUiSnippet {
	public AUiSnippetTableThermalAnalysis() {
		super("de.dlr.sc.virsat.model.extension.thermal",
			"ThermalAnalysis",
			"de.dlr.sc.virsat.model.extension.thermal.ThermalAnalysis",
			STYLE_ADD_BUTTON | STYLE_REMOVE_BUTTON | STYLE_EDITOR_BUTTON);
	}

	@Override
	protected Command createAddCommand(EditingDomain editingDomain, Concept activeConcept) {
		return new CreateAddThermalAnalysisCommand().create(editingDomain, model, activeConcept);
	}
}
