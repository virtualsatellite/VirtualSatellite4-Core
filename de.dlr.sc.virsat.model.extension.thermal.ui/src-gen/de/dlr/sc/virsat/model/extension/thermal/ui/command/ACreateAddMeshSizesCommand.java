...
import de.dlr.sc.virsat.model.extension.thermal.model.MeshSizes;
 ...
 * 
 */	
public abstract class ACreateAddMeshSizesCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		MeshSizes conceptObject = new MeshSizes(activeConcept);
