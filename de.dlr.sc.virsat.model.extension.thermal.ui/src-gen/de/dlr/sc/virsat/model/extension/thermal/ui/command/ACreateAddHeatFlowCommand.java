...
import de.dlr.sc.virsat.model.extension.thermal.model.HeatFlow;
 ...
 * 
 */	
public abstract class ACreateAddHeatFlowCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		HeatFlow conceptObject = new HeatFlow(activeConcept);
