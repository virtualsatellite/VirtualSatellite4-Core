 ...
 * 
 */	
public abstract class AAddThermalAnalysisResultsHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddThermalAnalysisResultsCommand().create(editingDomain, owner, activeConcept);
	}
}
