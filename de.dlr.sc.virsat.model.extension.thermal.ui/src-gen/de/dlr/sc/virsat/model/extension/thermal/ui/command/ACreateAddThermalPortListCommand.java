...
import de.dlr.sc.virsat.model.extension.thermal.model.ThermalPortList;
 ...
 * 
 */	
public abstract class ACreateAddThermalPortListCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		ThermalPortList conceptObject = new ThermalPortList(activeConcept);
