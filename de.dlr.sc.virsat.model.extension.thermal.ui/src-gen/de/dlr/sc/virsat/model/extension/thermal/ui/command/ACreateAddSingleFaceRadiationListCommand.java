...
import de.dlr.sc.virsat.model.extension.thermal.model.SingleFaceRadiationList;
 ...
 * 
 */	
public abstract class ACreateAddSingleFaceRadiationListCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		SingleFaceRadiationList conceptObject = new SingleFaceRadiationList(activeConcept);
