 ...
 * 
 */	
public abstract class AAddComponentMeshSizeHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddComponentMeshSizeCommand().create(editingDomain, owner, activeConcept);
	}
}
