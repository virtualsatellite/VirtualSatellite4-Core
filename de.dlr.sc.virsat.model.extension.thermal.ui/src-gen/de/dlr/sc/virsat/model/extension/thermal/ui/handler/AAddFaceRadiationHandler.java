 ...
 * 
 */	
public abstract class AAddFaceRadiationHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddFaceRadiationCommand().create(editingDomain, owner, activeConcept);
	}
}
