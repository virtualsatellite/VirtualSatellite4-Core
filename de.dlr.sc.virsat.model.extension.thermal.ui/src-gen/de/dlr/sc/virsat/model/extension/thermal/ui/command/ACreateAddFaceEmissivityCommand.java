...
import de.dlr.sc.virsat.model.extension.thermal.model.FaceEmissivity;
 ...
 * 
 */	
public abstract class ACreateAddFaceEmissivityCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		FaceEmissivity conceptObject = new FaceEmissivity(activeConcept);
