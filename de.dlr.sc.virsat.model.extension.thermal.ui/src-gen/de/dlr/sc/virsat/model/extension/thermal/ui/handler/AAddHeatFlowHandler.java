 ...
 * 
 */	
public abstract class AAddHeatFlowHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddHeatFlowCommand().create(editingDomain, owner, activeConcept);
	}
}
