 ...
 * 
 */	
public abstract class AAddTemperatureBoundaryHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTemperatureBoundaryCommand().create(editingDomain, owner, activeConcept);
	}
}
