...
import de.dlr.sc.virsat.model.extension.thermal.model.ComponentNameCat;
 ...
 * 
 */	
public abstract class ACreateAddComponentNameCatCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		ComponentNameCat conceptObject = new ComponentNameCat(activeConcept);
