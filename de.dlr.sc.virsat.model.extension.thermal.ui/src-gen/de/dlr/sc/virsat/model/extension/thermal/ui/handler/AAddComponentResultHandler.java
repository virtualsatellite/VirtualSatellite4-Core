 ...
 * 
 */	
public abstract class AAddComponentResultHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddComponentResultCommand().create(editingDomain, owner, activeConcept);
	}
}
