...
import de.dlr.sc.virsat.model.extension.thermal.model.PostProcessing;
 ...
 * 
 */	
public abstract class ACreateAddPostProcessingCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		PostProcessing conceptObject = new PostProcessing(activeConcept);
