 ...
 * 
 */	
public abstract class AAddAnalysisResultHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddAnalysisResultCommand().create(editingDomain, owner, activeConcept);
	}
}
