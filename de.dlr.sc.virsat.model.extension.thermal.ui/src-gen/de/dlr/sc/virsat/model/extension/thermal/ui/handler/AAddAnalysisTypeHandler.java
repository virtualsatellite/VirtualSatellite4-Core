 ...
 * 
 */	
public abstract class AAddAnalysisTypeHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddAnalysisTypeCommand().create(editingDomain, owner, activeConcept);
	}
}
