 ...
 * 
 */	
public abstract class AAddThermalElementParametersHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddThermalElementParametersCommand().create(editingDomain, owner, activeConcept);
	}
}
