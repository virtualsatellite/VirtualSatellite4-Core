 ...
 * 
 */	
public abstract class AAddThermalPortHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddThermalPortCommand().create(editingDomain, owner, activeConcept);
	}
}
