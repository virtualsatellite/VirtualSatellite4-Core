 ...
 * 
 */	
public abstract class AAddMeshSizesHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddMeshSizesCommand().create(editingDomain, owner, activeConcept);
	}
}
