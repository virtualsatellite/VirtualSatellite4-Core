 ...
 * 
 */	
public abstract class AAddBoundaryConditionsHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddBoundaryConditionsCommand().create(editingDomain, owner, activeConcept);
	}
}
