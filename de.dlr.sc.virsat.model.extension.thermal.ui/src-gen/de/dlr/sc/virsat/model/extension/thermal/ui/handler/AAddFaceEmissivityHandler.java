 ...
 * 
 */	
public abstract class AAddFaceEmissivityHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddFaceEmissivityCommand().create(editingDomain, owner, activeConcept);
	}
}
