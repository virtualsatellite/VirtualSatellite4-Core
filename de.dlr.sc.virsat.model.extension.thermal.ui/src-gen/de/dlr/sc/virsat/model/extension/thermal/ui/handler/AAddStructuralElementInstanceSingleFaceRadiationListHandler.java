 ...
 * 
 */	
public abstract class  AAddStructuralElementInstanceSingleFaceRadiationListHandler extends ATransactionalAddStructuralElementHandler implements IHandler {
	...
	protected String getStructuralElementName() {
		return "SingleFaceRadiationList";
	}
}
