...
import de.dlr.sc.virsat.model.extension.thermal.model.ThermalInterfaceList;
 ...
 * 
 */	
public abstract class ACreateAddThermalInterfaceListCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		ThermalInterfaceList conceptObject = new ThermalInterfaceList(activeConcept);
