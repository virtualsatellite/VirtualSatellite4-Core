...
import de.dlr.sc.virsat.model.extension.thermal.model.ThermalAnalysisResults;
 ...
 * 
 */	
public abstract class ACreateAddThermalAnalysisResultsCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		ThermalAnalysisResults conceptObject = new ThermalAnalysisResults(activeConcept);
