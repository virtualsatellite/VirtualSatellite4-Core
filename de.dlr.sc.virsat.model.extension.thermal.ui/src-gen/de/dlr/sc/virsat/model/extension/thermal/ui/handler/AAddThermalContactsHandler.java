 ...
 * 
 */	
public abstract class AAddThermalContactsHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddThermalContactsCommand().create(editingDomain, owner, activeConcept);
	}
}
