 ...
 * 
 */	
public abstract class AAddThermalInterfaceListHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddThermalInterfaceListCommand().create(editingDomain, owner, activeConcept);
	}
}
