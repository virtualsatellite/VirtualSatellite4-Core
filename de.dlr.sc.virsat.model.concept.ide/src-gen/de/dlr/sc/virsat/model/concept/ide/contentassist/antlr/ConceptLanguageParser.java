...
public class ConceptLanguageParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ConceptLanguageGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCategoryAccess().getAlternatives_5_2_2(), "rule__Category__Alternatives_5_2_2");
			...
			builder.put(grammarAccess.getCategoryAccess().getGroup_5_2_2_0(), "rule__Category__Group_5_2_2_0__0");
			builder.put(grammarAccess.getCategoryAccess().getGroup_5_2_2_0_2(), "rule__Category__Group_5_2_2_0_2__0");
			...
			builder.put(grammarAccess.getComposedPropertyAccess().getGroup_7_3(), "rule__ComposedProperty__Group_7_3__0");
			...
			builder.put(grammarAccess.getIntPropertyAccess().getGroup_4_4(), "rule__IntProperty__Group_4_4__0");
			...
			builder.put(grammarAccess.getFloatPropertyAccess().getGroup_4_4(), "rule__FloatProperty__Group_4_4__0");
			...
			builder.put(grammarAccess.getStringPropertyAccess().getGroup_4_2(), "rule__StringProperty__Group_4_2__0");
			...
			builder.put(grammarAccess.getBooleanPropertyAccess().getGroup_3_2(), "rule__BooleanProperty__Group_3_2__0");
			...
			builder.put(grammarAccess.getEnumPropertyAccess().getGroup_3_5(), "rule__EnumProperty__Group_3_5__0");
			...
			builder.put(grammarAccess.getEReferencePropertyAccess().getGroup_6_0(), "rule__EReferenceProperty__Group_6_0__0");
			builder.put(grammarAccess.getEReferencePropertyAccess().getGroup_6_1(), "rule__EReferenceProperty__Group_6_1__0");
			builder.put(grammarAccess.getResourcePropertyAccess().getGroup(), "rule__ResourceProperty__Group__0");
			builder.put(grammarAccess.getResourcePropertyAccess().getGroup_3_0(), "rule__ResourceProperty__Group_3_0__0");
			builder.put(grammarAccess.getResourcePropertyAccess().getGroup_3_1(), "rule__ResourceProperty__Group_3_1__0");
			...
			builder.put(grammarAccess.getCategoryAccess().getIsVerificationAssignment_5_1_0(), "rule__Category__IsVerificationAssignment_5_1_0");
			builder.put(grammarAccess.getCategoryAccess().getApplicableForAssignment_5_2_2_0_1(), "rule__Category__ApplicableForAssignment_5_2_2_0_1");
			builder.put(grammarAccess.getCategoryAccess().getApplicableForAssignment_5_2_2_0_2_1(), "rule__Category__ApplicableForAssignment_5_2_2_0_2_1");
			builder.put(grammarAccess.getCategoryAccess().getIsApplicableForAllAssignment_5_2_2_1(), "rule__Category__IsApplicableForAllAssignment_5_2_2_1");
			builder.put(grammarAccess.getCategoryAccess().getCardinalityAssignment_5_3_1(), "rule__Category__CardinalityAssignment_5_3_1");
			...
			builder.put(grammarAccess.getVerificationTypeSpecificationAccess().getVerificationTypeAssignment(), "rule__VerificationTypeSpecification__VerificationTypeAssignment");
			...
			builder.put(grammarAccess.getComposedPropertyAccess().getVerificationAssignment_7_2_1(), "rule__ComposedProperty__VerificationAssignment_7_2_1");
			builder.put(grammarAccess.getComposedPropertyAccess().getUnitNameAssignment_7_3_1(), "rule__ComposedProperty__UnitNameAssignment_7_3_1");
			...
			builder.put(grammarAccess.getIntPropertyAccess().getVerificationAssignment_4_3_1(), "rule__IntProperty__VerificationAssignment_4_3_1");
			builder.put(grammarAccess.getIntPropertyAccess().getUnitNameAssignment_4_4_1(), "rule__IntProperty__UnitNameAssignment_4_4_1");
			...
			builder.put(grammarAccess.getFloatPropertyAccess().getVerificationAssignment_4_3_1(), "rule__FloatProperty__VerificationAssignment_4_3_1");
			builder.put(grammarAccess.getFloatPropertyAccess().getUnitNameAssignment_4_4_1(), "rule__FloatProperty__UnitNameAssignment_4_4_1");
			...
			builder.put(grammarAccess.getStringPropertyAccess().getVerificationAssignment_4_1_1(), "rule__StringProperty__VerificationAssignment_4_1_1");
			builder.put(grammarAccess.getStringPropertyAccess().getDefaultValueAssignment_4_2_1(), "rule__StringProperty__DefaultValueAssignment_4_2_1");
			...
			builder.put(grammarAccess.getBooleanPropertyAccess().getVerificationAssignment_3_1_1(), "rule__BooleanProperty__VerificationAssignment_3_1_1");
			builder.put(grammarAccess.getBooleanPropertyAccess().getDefaultValueAssignment_3_2_1(), "rule__BooleanProperty__DefaultValueAssignment_3_2_1");
			...
			builder.put(grammarAccess.getEnumPropertyAccess().getVerificationAssignment_3_4_1(), "rule__EnumProperty__VerificationAssignment_3_4_1");
			builder.put(grammarAccess.getEnumPropertyAccess().getDefaultValueAssignment_3_5_1(), "rule__EnumProperty__DefaultValueAssignment_3_5_1");
			...
			builder.put(grammarAccess.getReferencePropertyAccess().getDescriptionAssignment_6_0_1(), "rule__ReferenceProperty__DescriptionAssignment_6_0_1");
			builder.put(grammarAccess.getReferencePropertyAccess().getVerificationAssignment_6_1_1(), "rule__ReferenceProperty__VerificationAssignment_6_1_1");
			...
			builder.put(grammarAccess.getEReferencePropertyAccess().getDescriptionAssignment_6_0_1(), "rule__EReferenceProperty__DescriptionAssignment_6_0_1");
			builder.put(grammarAccess.getEReferencePropertyAccess().getVerificationAssignment_6_1_1(), "rule__EReferenceProperty__VerificationAssignment_6_1_1");
			...
			builder.put(grammarAccess.getResourcePropertyAccess().getDescriptionAssignment_3_0_1(), "rule__ResourceProperty__DescriptionAssignment_3_0_1");
			builder.put(grammarAccess.getResourcePropertyAccess().getVerificationAssignment_3_1_1(), "rule__ResourceProperty__VerificationAssignment_3_1_1");
			...
			builder.put(grammarAccess.getReferencePropertyAccess().getUnorderedGroup_6(), "rule__ReferenceProperty__UnorderedGroup_6");
			builder.put(grammarAccess.getEReferencePropertyAccess().getUnorderedGroup_6(), "rule__EReferenceProperty__UnorderedGroup_6");
			builder.put(grammarAccess.getResourcePropertyAccess().getUnorderedGroup_3(), "rule__ResourceProperty__UnorderedGroup_3");
		}
	}
