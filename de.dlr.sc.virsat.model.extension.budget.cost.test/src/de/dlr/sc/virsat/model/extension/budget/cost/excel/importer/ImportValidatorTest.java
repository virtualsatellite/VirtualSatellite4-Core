...
public class ImportValidatorTest extends ExcelTestCase {
	...
	public void testValidateCostEquipmentSheet() throws IOException {
		...
		expectedFaults.add(new Fault(FaultType.DELETE_COLUMN_CAN_BE_EMPTY_OR_1, costEquipmentSheetIndex, AExcelCostIO.COMMON_ROW_START_TABLE + 2));
	...
	public void testValidateEmptyCostTypeSheet() throws IOException {
		...
		expectedFault.add(new Fault(FaultType.DELETE_COLUMN_CAN_BE_EMPTY_OR_1, interfaceTypeSheetIndex, AExcelCostIO.COMMON_ROW_START_TABLE + 1));
