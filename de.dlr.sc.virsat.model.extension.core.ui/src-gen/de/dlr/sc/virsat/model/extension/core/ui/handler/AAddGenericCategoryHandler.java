 ...
 *******************************************************************************/
package de.dlr.sc.virsat.model.extension.core.ui.handler;
...
public abstract class AAddGenericCategoryHandler extends ATransactionalAddCategoryHandler {
	...
	protected String getConceptName() {
		return "de.dlr.sc.virsat.model.extension.core";
	}
	
	@Override
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddGenericCategoryCommand().create(editingDomain, owner, activeConcept);
	}
}
