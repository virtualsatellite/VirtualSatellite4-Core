/**
 */
package de.dlr.sc.virsat.model.external.tests.util;
...
public class TestsAdapterFactory extends AdapterFactoryImpl {
	...
	protected TestsSwitch<Adapter> modelSwitch =
		new TestsSwitch<Adapter>() {
			@Override
			public Adapter caseExternalTestType(ExternalTestType object) {
				return createExternalTestTypeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dlr.sc.virsat.model.external.tests.ExternalTestType <em>External Test Type</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createExternalTestTypeAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link de.dlr.sc.virsat.model.external.tests.SuperType <em>Super Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dlr.sc.virsat.model.external.tests.Container <em>Container</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
