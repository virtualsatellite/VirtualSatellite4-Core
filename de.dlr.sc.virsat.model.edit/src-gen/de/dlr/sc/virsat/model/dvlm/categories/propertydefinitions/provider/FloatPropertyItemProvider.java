...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.categories.propertydefinitions.FloatProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FloatPropertyItemProvider extends AQudvTypePropertyItemProvider {
	/**
	 ...
	 * @generated
	 */
	public FloatPropertyItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IIntrinsicTypeProperty_defaultValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IIntrinsicTypeProperty_defaultValue_feature", "_UI_IIntrinsicTypeProperty_type"),
	 ...
	 * *********************************
	 * This returns FloatProperty.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		...
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FloatProperty")); 
	}
	...
	public String getText(Object object) {
			...
			String label = ((FloatProperty)object).getName();
      	
    	
			return label == null || label.length() == 0 ?
				getString("_UI_FloatProperty_type") :
				getString("_UI_FloatProperty_type") + " " + label;
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FloatProperty.class)) {
