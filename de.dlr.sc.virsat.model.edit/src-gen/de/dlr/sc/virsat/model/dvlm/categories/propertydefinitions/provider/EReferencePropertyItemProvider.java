...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.categories.propertydefinitions.EReferenceProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EReferencePropertyItemProvider extends APropertyItemProvider {
	/**
	 ...
	 * @generated
	 */
	public EReferencePropertyItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EReferenceProperty_referenceType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EReferenceProperty_referenceType_feature", "_UI_EReferenceProperty_type"),
				 PropertydefinitionsPackage.Literals.EREFERENCE_PROPERTY__REFERENCE_TYPE,
				 true,
				 false,
				 true,
				 null,
	 ...
	 * *********************************
	 * This returns EReferenceProperty.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EReferenceProperty")); 
	}
	...
	public String getText(Object object) {
			...
			String label = ((EReferenceProperty)object).getName();
			return label == null || label.length() == 0 ?
				getString("_UI_EReferenceProperty_type") :
				getString("_UI_EReferenceProperty_type") + " " + label;
	}
