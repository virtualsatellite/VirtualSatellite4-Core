...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.structural.GeneralRelation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GeneralRelationItemProvider 
	 ...
	 * @generated
	 */
	public GeneralRelationItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addReferencedTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GeneralRelation_referencedType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GeneralRelation_referencedType_feature", "_UI_GeneralRelation_type"),
				 StructuralPackage.Literals.GENERAL_RELATION__REFERENCED_TYPE,
				 false,
				 false,
				 true,
				 null,
	 ...
	 * *********************************
	 * This returns GeneralRelation.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GeneralRelation")); 
	}
	...
	public String getText(Object object) {
			...
			String label = ((GeneralRelation)object).getName();
			return label == null || label.length() == 0 ?
				getString("_UI_GeneralRelation_type") :
				getString("_UI_GeneralRelation_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GeneralRelation.class)) {
