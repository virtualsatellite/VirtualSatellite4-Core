...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.categories.propertydefinitions.EnumValueDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumValueDefinitionItemProvider 
	 ...
	 * @generated
	 */
	public EnumValueDefinitionItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EnumValueDefinition_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EnumValueDefinition_value_feature", "_UI_EnumValueDefinition_type"),
				 PropertydefinitionsPackage.Literals.ENUM_VALUE_DEFINITION__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	 ...
	 * *********************************
	 * This returns EnumValueDefinition.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EnumValueDefinition")); 
	}
	...
	public String getText(Object object) {
			...
			String label = ((EnumValueDefinition)object).getName();
			return label == null || label.length() == 0 ?
				getString("_UI_EnumValueDefinition_type") :
				getString("_UI_EnumValueDefinition_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EnumValueDefinition.class)) {
