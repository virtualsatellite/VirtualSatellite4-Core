...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.concepts.ConceptImport} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConceptImportItemProvider 
	 ...
	 * @generated
	 */
	public ConceptImportItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConceptImport_importedNamespace_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConceptImport_importedNamespace_feature", "_UI_ConceptImport_type"),
				 ConceptsPackage.Literals.CONCEPT_IMPORT__IMPORTED_NAMESPACE,
				 false,
				 false,
				 false,
	 ...
	 * *********************************
	 * This returns ConceptImport.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConceptImport")); 
	}
	...
	public String getText(Object object) {
			...
			String label = ((ConceptImport)object).getImportedNamespace();
			return label == null || label.length() == 0 ?
				getString("_UI_ConceptImport_type") :
				getString("_UI_ConceptImport_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConceptImport.class)) {
			case ConceptsPackage.CONCEPT_IMPORT__IMPORTED_NAMESPACE:
