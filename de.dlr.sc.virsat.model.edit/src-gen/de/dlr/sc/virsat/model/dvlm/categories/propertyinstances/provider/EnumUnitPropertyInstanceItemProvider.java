...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.categories.propertyinstances.EnumUnitPropertyInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumUnitPropertyInstanceItemProvider extends APropertyInstanceItemProvider {
	/**
	...
	protected void addUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IUnitPropertyInstance_unit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IUnitPropertyInstance_unit_feature", "_UI_IUnitPropertyInstance_type"),
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EnumUnitPropertyInstance_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EnumUnitPropertyInstance_value_feature", "_UI_EnumUnitPropertyInstance_type"),
	 ...
	 * *********************************
	 * This returns EnumUnitPropertyInstance.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) { 
		Object rtrnObj = overlayImage(object, getResourceLocator().getImage("full/obj16/EnumUnitPropertyInstance")); 
	...
	public String getText(Object object) {
			...
			VirSatUuid labelValue = ((EnumUnitPropertyInstance)object).getUuid();
			String label = labelValue == null ? null : labelValue.toString();
			return label == null || label.length() == 0 ?
				getString("_UI_EnumUnitPropertyInstance_type") :
				getString("_UI_EnumUnitPropertyInstance_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EnumUnitPropertyInstance.class)) {
