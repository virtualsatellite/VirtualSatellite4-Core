...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.qudv.QuantityKind} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QuantityKindItemProvider extends AQuantityKindItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_QuantityKind_general_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_QuantityKind_general_feature", "_UI_QuantityKind_type"),
				 QudvPackage.Literals.QUANTITY_KIND__GENERAL,
				 false,
				 false,
				 true,
				 null,
