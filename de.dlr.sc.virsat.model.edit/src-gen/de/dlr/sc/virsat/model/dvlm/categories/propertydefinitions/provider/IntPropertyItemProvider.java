...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.categories.propertydefinitions.IntProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntPropertyItemProvider extends AQudvTypePropertyItemProvider {
	/**
	...
	public String getText(Object object) {
			...
			String label = ((IntProperty)object).getName();
			return label == null || label.length() == 0 ?
				getString("_UI_IntProperty_type") :
				getString("_UI_IntProperty_type") + " " + label;
	}
