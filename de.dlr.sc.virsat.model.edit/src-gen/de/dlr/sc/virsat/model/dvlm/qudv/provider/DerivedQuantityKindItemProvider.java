...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.qudv.DerivedQuantityKind} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DerivedQuantityKindItemProvider extends AQuantityKindItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DerivedQuantityKindItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QudvPackage.Literals.DERIVED_QUANTITY_KIND__FACTOR);
		}
	 ...
	 * *********************************
	 * This returns DerivedQuantityKind.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DerivedQuantityKind")); 
	}
	...
	public String getText(Object object) {
			...
			String label = ((DerivedQuantityKind)object).getSymbol();
			return label == null || label.length() == 0 ?
				getString("_UI_DerivedQuantityKind_type") :
				getString("_UI_DerivedQuantityKind_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DerivedQuantityKind.class)) {
			case QudvPackage.DERIVED_QUANTITY_KIND__FACTOR:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QudvPackage.Literals.DERIVED_QUANTITY_KIND__FACTOR,
				 QudvFactory.eINSTANCE.createQuantityKindFactor()));
	}
