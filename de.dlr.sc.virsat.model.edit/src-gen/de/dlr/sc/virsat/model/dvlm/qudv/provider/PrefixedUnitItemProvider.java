...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.qudv.PrefixedUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrefixedUnitItemProvider extends AConversionBasedUnitItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PrefixedUnitItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PrefixedUnit_prefix_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PrefixedUnit_prefix_feature", "_UI_PrefixedUnit_type"),
				 QudvPackage.Literals.PREFIXED_UNIT__PREFIX,
				 false,
				 false,
				 true,
				 null,
