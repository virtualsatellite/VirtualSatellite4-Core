...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.categories.propertydefinitions.ComposedProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComposedPropertyItemProvider extends APropertyItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ComposedPropertyItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComposedProperty_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComposedProperty_type_feature", "_UI_ComposedProperty_type"),
				 PropertydefinitionsPackage.Literals.COMPOSED_PROPERTY__TYPE,
				 false,
				 false,
				 true,
				 null,
	...
	protected void addQuantityKindNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComposedProperty_quantityKindName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComposedProperty_quantityKindName_feature", "_UI_ComposedProperty_type"),
				 PropertydefinitionsPackage.Literals.COMPOSED_PROPERTY__QUANTITY_KIND_NAME,
				 true,
				 false,
				 false,
	...
	protected void addUnitNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComposedProperty_unitName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComposedProperty_unitName_feature", "_UI_ComposedProperty_type"),
				 PropertydefinitionsPackage.Literals.COMPOSED_PROPERTY__UNIT_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	 ...
	 * *********************************
	 * This returns ComposedProperty.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ComposedProperty")); 
	}
	...
	public String getText(Object object) {
			...
			String label = ((ComposedProperty)object).getName();
			return label == null || label.length() == 0 ?
				getString("_UI_ComposedProperty_type") :
				getString("_UI_ComposedProperty_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ComposedProperty.class)) {
