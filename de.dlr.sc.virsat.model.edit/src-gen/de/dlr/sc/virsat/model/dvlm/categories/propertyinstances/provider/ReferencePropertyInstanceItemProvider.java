...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.categories.propertyinstances.ReferencePropertyInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReferencePropertyInstanceItemProvider extends APropertyInstanceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ReferencePropertyInstanceItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addReferencePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReferencePropertyInstance_reference_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReferencePropertyInstance_reference_feature", "_UI_ReferencePropertyInstance_type"),
				 PropertyinstancesPackage.Literals.REFERENCE_PROPERTY_INSTANCE__REFERENCE,
				 true,
				 false,
				 true,
				 null,
	 ...
	 * *********************************
	 * This returns ReferencePropertyInstance.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) { 
		Object rtrnObj = overlayImage(object, getResourceLocator().getImage("full/obj16/ReferencePropertyInstance")); 
	...
	public String getText(Object object) {
			...
			VirSatUuid labelValue = ((ReferencePropertyInstance)object).getUuid();
			String label = labelValue == null ? null : labelValue.toString();
			return label == null || label.length() == 0 ?
				getString("_UI_ReferencePropertyInstance_type") :
				getString("_UI_ReferencePropertyInstance_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ReferencePropertyInstance.class)) {
