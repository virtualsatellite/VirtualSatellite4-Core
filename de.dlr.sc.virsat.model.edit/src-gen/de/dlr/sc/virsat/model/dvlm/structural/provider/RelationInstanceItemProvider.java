...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.structural.RelationInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationInstanceItemProvider 
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RelationInstance_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RelationInstance_type_feature", "_UI_RelationInstance_type"),
				 StructuralPackage.Literals.RELATION_INSTANCE__TYPE,
				 false,
				 false,
				 true,
				 null,
	...
	protected void addReferencesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RelationInstance_references_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RelationInstance_references_feature", "_UI_RelationInstance_type"),
				 StructuralPackage.Literals.RELATION_INSTANCE__REFERENCES,
				 false,
				 false,
				 true,
				 null,
