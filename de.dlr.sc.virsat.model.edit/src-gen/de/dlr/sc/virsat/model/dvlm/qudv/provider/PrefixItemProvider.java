...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.qudv.Prefix} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addSymbolPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Prefix_symbol_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Prefix_symbol_feature", "_UI_Prefix_type"),
				 QudvPackage.Literals.PREFIX__SYMBOL,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addFactorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Prefix_factor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Prefix_factor_feature", "_UI_Prefix_type"),
				 QudvPackage.Literals.PREFIX__FACTOR,
				 false,
				 false,
				 false,
