...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.qudv.AConversionBasedUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AConversionBasedUnitItemProvider extends AUnitItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AConversionBasedUnitItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIsInvertiblePropertyDescriptor(object);
			addReferenceUnitPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Is Invertible feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsInvertiblePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AConversionBasedUnit_isInvertible_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AConversionBasedUnit_isInvertible_feature", "_UI_AConversionBasedUnit_type"),
				 QudvPackage.Literals.ACONVERSION_BASED_UNIT__IS_INVERTIBLE,
				 false,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Reference Unit feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addReferenceUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AConversionBasedUnit_referenceUnit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AConversionBasedUnit_referenceUnit_feature", "_UI_AConversionBasedUnit_type"),
				 QudvPackage.Literals.ACONVERSION_BASED_UNIT__REFERENCE_UNIT,
				 false,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AConversionBasedUnit.class)) {
