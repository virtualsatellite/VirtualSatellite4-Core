...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.qudv.AffineConversionUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AffineConversionUnitItemProvider extends AConversionBasedUnitItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AffineConversionUnitItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AffineConversionUnit_factor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AffineConversionUnit_factor_feature", "_UI_AffineConversionUnit_type"),
				 QudvPackage.Literals.AFFINE_CONVERSION_UNIT__FACTOR,
				 false,
				 false,
				 false,
	...
	protected void addOffsetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AffineConversionUnit_offset_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AffineConversionUnit_offset_feature", "_UI_AffineConversionUnit_type"),
				 QudvPackage.Literals.AFFINE_CONVERSION_UNIT__OFFSET,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	 ...
	 * *********************************
	 * This returns AffineConversionUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AffineConversionUnit")); 
	}
	...
	public String getText(Object object) {
		...
		String labelName =((AffineConversionUnit)object).getName();
		String label =((AffineConversionUnit)object).getSymbol();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AffineConversionUnit.class)) {
