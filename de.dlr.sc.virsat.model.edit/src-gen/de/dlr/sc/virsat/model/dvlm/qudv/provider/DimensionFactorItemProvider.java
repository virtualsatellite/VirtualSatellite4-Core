...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.qudv.DimensionFactor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DimensionFactorItemProvider 
	 ...
	 * @generated
	 */
	public DimensionFactorItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DimensionFactor_exponent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DimensionFactor_exponent_feature", "_UI_DimensionFactor_type"),
				 QudvPackage.Literals.DIMENSION_FACTOR__EXPONENT,
				 false,
				 false,
				 false,
	...
	protected void addBaseDimensionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DimensionFactor_baseDimension_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DimensionFactor_baseDimension_feature", "_UI_DimensionFactor_type"),
				 QudvPackage.Literals.DIMENSION_FACTOR__BASE_DIMENSION,
				 false,
				 false,
				 true,
				 null,
	 ...
	 * *********************************
	 * This returns DimensionFactor.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DimensionFactor.class)) {
