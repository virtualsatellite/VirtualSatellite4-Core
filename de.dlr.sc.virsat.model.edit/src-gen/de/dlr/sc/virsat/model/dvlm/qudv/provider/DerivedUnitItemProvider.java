...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.qudv.DerivedUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DerivedUnitItemProvider extends AUnitItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DerivedUnitItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QudvPackage.Literals.DERIVED_UNIT__FACTOR);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DerivedUnit")); 
	}
	...
	public String getText(Object object) {
		...
		String labelName =((DerivedUnit)object).getName();
		String label =((DerivedUnit)object).getSymbol();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DerivedUnit.class)) {
			case QudvPackage.DERIVED_UNIT__FACTOR:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QudvPackage.Literals.DERIVED_UNIT__FACTOR,
				 QudvFactory.eINSTANCE.createUnitFactor()));
	}
