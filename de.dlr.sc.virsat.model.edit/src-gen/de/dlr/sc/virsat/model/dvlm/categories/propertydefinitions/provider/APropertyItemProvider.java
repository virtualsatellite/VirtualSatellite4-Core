...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.categories.propertydefinitions.AProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class APropertyItemProvider extends ATypeDefinitionItemProvider {
	/**
	...
	public String getText(Object object) {
			...
			String label = ((AProperty)object).getName();
      	
    	
			return label == null || label.length() == 0 ?
				getString("_UI_AProperty_type") :
				getString("_UI_AProperty_type") + " " + label;
