...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.calculation.SetFunction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SetFunctionItemProvider extends AAdvancedFunctionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SetFunctionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SetFunction_typeDefinition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SetFunction_typeDefinition_feature", "_UI_SetFunction_type"),
				 CalculationPackage.Literals.SET_FUNCTION__TYPE_DEFINITION,
				 false,
				 false,
				 true,
				 null,
	...
	protected void addFilterNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SetFunction_filterName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SetFunction_filterName_feature", "_UI_SetFunction_type"),
				 CalculationPackage.Literals.SET_FUNCTION__FILTER_NAME,
				 false,
				 false,
				 false,
	...
	protected void addDepthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SetFunction_depth_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SetFunction_depth_feature", "_UI_SetFunction_type"),
				 CalculationPackage.Literals.SET_FUNCTION__DEPTH,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SetFunction")); 
	}
	...
	public String getText(Object object) {
			...
			String label = ((SetFunction)object).getFilterName();
			return label == null || label.length() == 0 ?
				getString("_UI_SetFunction_type") :
				getString("_UI_SetFunction_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SetFunction.class)) {
