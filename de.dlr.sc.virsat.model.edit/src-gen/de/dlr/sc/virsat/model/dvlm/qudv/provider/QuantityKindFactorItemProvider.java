...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.qudv.QuantityKindFactor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QuantityKindFactorItemProvider 
	 ...
	 * @generated
	 */
	public QuantityKindFactorItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addExponentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_QuantityKindFactor_exponent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_QuantityKindFactor_exponent_feature", "_UI_QuantityKindFactor_type"),
				 QudvPackage.Literals.QUANTITY_KIND_FACTOR__EXPONENT,
				 false,
				 false,
				 false,
	...
	protected void addQuantityKindPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_QuantityKindFactor_quantityKind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_QuantityKindFactor_quantityKind_feature", "_UI_QuantityKindFactor_type"),
				 QudvPackage.Literals.QUANTITY_KIND_FACTOR__QUANTITY_KIND,
				 false,
				 false,
				 true,
				 null,
	 ...
	 * *********************************
	 * This returns QuantityKindFactor.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/QuantityKindFactor")); 
	}
	...
	public String getText(Object object) {
			...
			QuantityKindFactor quantityKindFactor = (QuantityKindFactor)object;
			return getString("_UI_QuantityKindFactor_type") + " " + quantityKindFactor.getExponent();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(QuantityKindFactor.class)) {
