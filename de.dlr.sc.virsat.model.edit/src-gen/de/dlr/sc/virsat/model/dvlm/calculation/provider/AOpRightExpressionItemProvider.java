...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.calculation.AOpRightExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AOpRightExpressionItemProvider extends AExpressionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AOpRightExpressionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AOpRightExpression_operator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AOpRightExpression_operator_feature", "_UI_AOpRightExpression_type"),
				 CalculationPackage.Literals.AOP_RIGHT_EXPRESSION__OPERATOR,
				 false,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CalculationPackage.Literals.AOP_RIGHT_EXPRESSION__RIGHT);
		}
	...
	public String getText(Object object) {
			...
			AOpRightExpression aOpRightExpression = (AOpRightExpression)object;
			return getString("_UI_AOpRightExpression_type") + " " + aOpRightExpression.isIsInherited();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AOpRightExpression.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CalculationPackage.Literals.AOP_RIGHT_EXPRESSION__RIGHT,
