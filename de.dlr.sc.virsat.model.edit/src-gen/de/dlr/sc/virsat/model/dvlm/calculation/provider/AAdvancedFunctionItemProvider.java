...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.calculation.AAdvancedFunction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AAdvancedFunctionItemProvider extends AExpressionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AAdvancedFunctionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AAdvancedFunction_operator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AAdvancedFunction_operator_feature", "_UI_AAdvancedFunction_type"),
				 CalculationPackage.Literals.AADVANCED_FUNCTION__OPERATOR,
				 false,
				 false,
				 false,
	...
	public String getText(Object object) {
			...
			AAdvancedFunction aAdvancedFunction = (AAdvancedFunction)object;
			return getString("_UI_AAdvancedFunction_type") + " " + aAdvancedFunction.isIsInherited();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AAdvancedFunction.class)) {
