...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.calculation.ReferencedInput} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReferencedInputItemProvider extends ALiteralItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ReferencedInputItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReferencedInput_reference_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReferencedInput_reference_feature", "_UI_ReferencedInput_type"),
				 CalculationPackage.Literals.REFERENCED_INPUT__REFERENCE,
				 false,
				 false,
				 true,
				 null,
	...
	protected void addDefinitionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReferencedInput_definition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReferencedInput_definition_feature", "_UI_ReferencedInput_type"),
				 CalculationPackage.Literals.REFERENCED_INPUT__DEFINITION,
				 false,
				 false,
				 true,
				 null,
	 ...
	 * *********************************
	 * This returns ReferencedInput.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
