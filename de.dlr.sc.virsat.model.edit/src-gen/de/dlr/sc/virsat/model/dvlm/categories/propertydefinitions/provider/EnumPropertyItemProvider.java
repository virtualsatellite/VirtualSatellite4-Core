...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.categories.propertydefinitions.EnumProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumPropertyItemProvider extends AQudvTypePropertyItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EnumProperty_defaultValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EnumProperty_defaultValue_feature", "_UI_EnumProperty_type"),
				 PropertydefinitionsPackage.Literals.ENUM_PROPERTY__DEFAULT_VALUE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PropertydefinitionsPackage.Literals.ENUM_PROPERTY__VALUES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PropertydefinitionsPackage.Literals.ENUM_PROPERTY__VALUES,
				 PropertydefinitionsFactory.eINSTANCE.createEnumValueDefinition()));
	}
