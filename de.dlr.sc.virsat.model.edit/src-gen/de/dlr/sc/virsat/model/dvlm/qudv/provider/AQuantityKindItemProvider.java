...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.qudv.AQuantityKind} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AQuantityKindItemProvider 
	 ...
	 * @generated
	 */
	public AQuantityKindItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addSymbolPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AQuantityKind_symbol_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AQuantityKind_symbol_feature", "_UI_AQuantityKind_type"),
				 QudvPackage.Literals.AQUANTITY_KIND__SYMBOL,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AQuantityKind_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AQuantityKind_description_feature", "_UI_AQuantityKind_type"),
				 QudvPackage.Literals.AQUANTITY_KIND__DESCRIPTION,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDefinitionURIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AQuantityKind_definitionURI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AQuantityKind_definitionURI_feature", "_UI_AQuantityKind_type"),
				 QudvPackage.Literals.AQUANTITY_KIND__DEFINITION_URI,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
			...
			String label = ((AQuantityKind)object).getSymbol();
			return label == null || label.length() == 0 ?
				getString("_UI_AQuantityKind_type") :
				getString("_UI_AQuantityKind_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AQuantityKind.class)) {
