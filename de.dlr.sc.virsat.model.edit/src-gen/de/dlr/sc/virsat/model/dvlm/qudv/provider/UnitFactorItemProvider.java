...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.virsat.model.dvlm.qudv.UnitFactor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnitFactorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QudvPackage.Literals.UNIT_FACTOR__EXPONENT,
				 false,
				 false,
				 false,
	...
	protected void addUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UnitFactor_unit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UnitFactor_unit_feature", "_UI_UnitFactor_type"),
				 QudvPackage.Literals.UNIT_FACTOR__UNIT,
				 false,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
			...
			UnitFactor unitFactor = (UnitFactor)object;
			return getString("_UI_UnitFactor_type") + " " + unitFactor.getExponent();
