 ...
 *******************************************************************************/
package de.dlr.sc.virsat.model.extension.maturity.ui.command;
 ...
 * 
 */	
public abstract class ACreateAddMaturityCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		Maturity conceptObject = new Maturity(activeConcept);
