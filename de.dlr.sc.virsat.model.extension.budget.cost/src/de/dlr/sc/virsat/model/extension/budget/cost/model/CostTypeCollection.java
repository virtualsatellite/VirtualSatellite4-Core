 ...
 * 
 */
public class CostTypeCollection extends ACostTypeCollection {
	...
	/**
 	 ...
 	 */
	public CostTypeCollection(Concept concept) {
		super(concept);
	}	
	 ...
	 */
	public CostTypeCollection(StructuralElementInstance sei) {
		super(sei);
	}
}
