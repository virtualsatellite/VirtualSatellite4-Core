 ...
 * 
 */
public class CostTypesCollection extends ACostTypesCollection {
	
	/**
	 * Constructor of Concept Class
	 */
	public CostTypesCollection() {
		super();
	}
	...
	/**
 	 ...
 	 */
	public CostTypesCollection(Concept concept) {
		super(concept);
	}	
	 ...
	 */
	public CostTypesCollection(StructuralElementInstance sei) {
		super(sei);
	}
}
