 ...
 * 
 */	
public abstract class ACostTypesCollection extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.budget.cost.CostTypesCollection";
	 ...
	 */
	public ACostTypesCollection(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "CostTypesCollection");
	 ...
	 */
	public ACostTypesCollection(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
