 ...
 * 
 */	
public abstract class ACostTypeCollection extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.budget.cost.CostTypeCollection";
	 ...
	 */
	public ACostTypeCollection(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "CostTypeCollection");
	 ...
	 */
	public ACostTypeCollection(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
