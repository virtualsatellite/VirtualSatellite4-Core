...
import de.dlr.sc.virsat.model.extension.ps.ui.wizards.ConfigureProductWizard;
 ...
 *
 */
public class ConfigureHandler extends AbstractHandler implements IHandler {
	@Override
	public Object execute(ExecutionEvent event) throws ExecutionException {
		ISelection selection = HandlerUtil.getCurrentSelectionChecked(event);
		Shell shell = HandlerUtil.getActiveWorkbenchWindow(event).getShell();
		ConfigureProductWizard wizard = new ConfigureProductWizard();
	...
	public boolean isEnabled() {
		...
		if (eObject instanceof StructuralElementInstance && hasRights) {
			...
			return (type.equals(ConfigurationTree.class.getSimpleName()) || type.equals(AssemblyTree.class.getSimpleName()));
