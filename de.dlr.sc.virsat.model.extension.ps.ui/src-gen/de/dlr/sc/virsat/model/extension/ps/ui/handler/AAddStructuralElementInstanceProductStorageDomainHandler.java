 ...
 * 
 */	
public abstract class  AAddStructuralElementInstanceProductStorageDomainHandler extends ATransactionalAddStructuralElementHandler implements IHandler {

	@Override
	protected String getConceptName() {
		return "de.dlr.sc.virsat.model.extension.ps";
	}

	@Override
	protected String getStructuralElementName() {
		return "ProductStorageDomain";
	}
}
